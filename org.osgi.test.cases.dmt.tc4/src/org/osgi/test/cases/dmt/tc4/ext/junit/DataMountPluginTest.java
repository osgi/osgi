...
public class DataMountPluginTest extends DmtAdminTestCase {
    ...
    /*
     * Multiple dataRootURIs and zero length mountPoints should succeeds to be registered. 
     */
    ...
    /*
     * Multiple dataRootURIs and more than one mountPoints should not succeeds to be registered. 
     */
    ...
    /*
     * If mountPoints contains an invalid URI value such as null, the plugin should be ignored.
     */
    ...
    /*
     * If mountPoints contains an invalid URI such as absolute URI, the plugin should be ignored.
     */
    ...
    public void testMountAlgorithmPattern03() throws DmtException {
        ...
        assertEquals(null, session.getNodeValue("./A1/B1"));
        assertEquals("./A1/B1/C1:Title", session.getNodeTitle("./A1/B1/C1"));
        assertEquals("./A1/B1/C1:Type", session.getNodeType("./A1/B1/C1"));
        assertEquals(new DmtData("./A1/B1/C1:Value"), session.getNodeValue("./A1/B1/C1"));
    	session.close();
