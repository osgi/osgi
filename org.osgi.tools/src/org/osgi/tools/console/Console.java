        ...
        Runnable
{
    ...
    public void start( BundleContext context ) throws Exception {
        ...
        _context.registerService( CommandProvider.class.getName(), new Basic(this, context), null );
        Thread thread = new Thread( this );
        _tracker = new ServiceTracker( context, CommandProvider.class.getName(), null ) ;
        _tracker.open();
        try {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("To use console, do: telnet localhost " + _port );
            while ( _continue ) {
            ...
            if ( _continue ) {
                e.printStackTrace();
                try { Thread.sleep(5000*n++); _listen.close(); } catch( Exception ee){}
            }
        }
    }
