 ...
 *
 * This Test Class Validates the implementation of <code>getDisplayName</code> method of DeploymentPackage, 
 * according to the Mobile specification.
 */

public class GetDisplayName implements TestInterface {
	
	private DeploymentTestControl tbc;
	
	public GetDisplayName(DeploymentTestControl tbc){
		this.tbc = tbc;
	}
	
	public void run() {
		prepare();
		testGetDisplayName001();
		testGetDisplayName002();
	}
	...
	/**
	 * Asserts that it returns the display name of the deployment package when it is set in the headers
	 * 
	 * @spec DeploymentPackage.getDisplayName()
	 */
	private void testGetDisplayName001() {
		tbc.log("#testGetDisplayName001");
	...
	/**
	 * Asserts that it does not return the display name of the deployment package when it is not set in the headers
	 * 
	 * @spec DeploymentPackage.getDisplayName()
	 */
	private void testGetDisplayName002() {
		tbc.log("#testGetDisplayName002");
		DeploymentPackage dp = null;
		try {
