 ...
 * <code>getSymbolicName<code> method, according to MEG reference
 * documentation.
 */
public class GetSymbolicName {
    ...
    public GetSymbolicName(DeploymentTestControl tbc) {
        this.tbc = tbc;
    }

    public void run() {
        testGetSymbolicName001();
    }
     ...
     */
    private void testGetSymbolicName001() {
        tbc.log("#testGetSymbolicName001");
