...
public class ElementFactory extends DefaultElementFactory {
	
	public AbstractBundleData createBundleData(AbstractFrameworkAdaptor adapter, long id) throws IOException {
		return new BundleData((Adapter)adapter, id);
	}
}
