...
public class DNChainMatching {
	...
	/* Test cases */
	/*
	 * private static String chains[] = { "EMAILADDRESS=dudeman@us.ibm.com,
	 * UID=886293897, CN=Benjamin C. Reed, OU=EMPLOYEE, O=IBM, C=US; CN=IBM
	 * Certification Authority, O=International Business Machines Corporation,
	 * C=US; OU=Equifax Secure Certificate Authority, O=Equifax, C=US", "O=IBM,
	 * C=US; O=Equifax, C=US; C=CA", "EMAILADDRESS=dudeman@us.ibm.com,
	 * UID=886293897, CN=Benjamin C. Reed, OU=EMPLOYEE, O=IBM, C=US; CN=IBM
	 * Certification Authority, O=International Business Machines Corporation,
	 * C=US; OU=Equifax Secure Certificate Authority, O=Equifax, C=US",
	 * "EMAILADDRESS=dudeman@us.ibm.com, UID=886293897, CN=Benjamin C. Reed,
	 * OU=EMPLOYEE, O=IBM, C=US; CN=IBM Certification Authority, O=International
	 * Business Machines Corporation, C=US; OU=Equifax Secure Certificate
	 * Authority, O=Equifax, C=US", "EMAILADDRESS=dudeman@us.ibm.com,
	 * UID=886293897, CN=Benjamin C. Reed, OU=EMPLOYEE, O=IBM, C=US; CN=IBM
	 * Certification Authority, O=International Business Machines Corporation,
	 * C=US; OU=Equifax Secure Certificate Authority, O=Equifax, C=US",
	 * "EMAILADDRESS=dudeman@us.ibm.com, UID=886293897, CN=Benjamin C. Reed,
	 ...
	 * OU=EMPLOYEE, O=IBM, C=US; CN=IBM Certification Authority, O=International
	 * Business Machines Corporation, C=US; OU=Equifax Secure Certificate
	 * Authority, O=Equifax, C=US",}; private static String patterns[] = {
	 * "EMAILADDRESS=*, UID=*, CN=*, OU=EMPLOYEE, O=IBM, C=US; *; *,
	 * O=International Business Machines Corporation, C=US;*", "O=IBM, C=US;*;*,
	 * C=US;*", "*;*, C=US", "*;*, C=US;*", "*;*, C=US, *", "EMAILADDRESS=*,
	 * UID=*, CN=*, OU=EMPLOYEE, O=IBM, C=US; *; *, 0.0.0.3=*, C=US",
	 * "EMAILADDRESS=*, UID=*, CN=*, OU=EMPLOYEE, O=IBM, C=US; *; *, O=IBM,
	 * C=US", "EMAILADDRESS=*, UID=*, CN=*, OU=EMPLOYEE, O=IBM, C=US; *; *, O=*,
	 * C=US",}; private static boolean results[] = {true, true, true, true,
	 * false, false, false, true, };
	 * 
	 * public static void main(String[] args) throws IllegalArgumentException {
	 * for (int i = 0; i < chains.length; i++) { if (match(chains[i],
	 * patterns[i]) != results[i]) { System.out.print("Test " + i + " failed:
	 * "); System.out.print(chains[i]); System.out.print(results[i] ? " == " : "
	 * !="); System.out.println(patterns[i]); } else { System.out.println("Test " +
	 * i + " passed"); } } }
	 */
}
