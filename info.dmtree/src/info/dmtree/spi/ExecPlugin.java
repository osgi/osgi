 ...
 * in the <code>execRootURIs</code> registration parameter.
 * 
 * @version $Id$
 */
public interface ExecPlugin {
	 ...
	 * 
	 * @param session
	 *            a reference to the session in which the operation was issued,
	 *            must not be <code>null</code>
	 * @param nodePath
	 *            the absolute path of the node to be executed, must not be
	 *            <code>null</code>
	 * @param correlator
	 *            an identifier to associate this operation with any alerts sent
	 *            in response to it, can be <code>null</code>
	 * @param data
	 *            the parameter of the execute operation, can be
	 *            <code>null</code>
	 * @throws DmtException
	 *             with the following possible error codes:
	 *             <ul>
	 *             <li><code>NODE_NOT_FOUND</code> if the node does not exist
	 *             and the plugin does not allow executing unexisting nodes <li>
	 *             <code>METADATA_MISMATCH</code> if the command failed because
	 *             of meta-data restrictions <li><code>DATA_STORE_FAILURE</code>
