...
public interface NotificationService {
     ...
     *         <ul>
     *         <li>{@code UNAUTHORIZED} when the remote server rejected
     *         the request due to insufficient authorization
     *         <li>{@code ALERT_NOT_ROUTED} when the alert can not be
     *         routed to the given principal
     *         <li>{@code REMOTE_ERROR} in case of communication
     ...
     *         <li>{@code FEATURE_NOT_SUPPORTED} if the underlying
