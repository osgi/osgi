...
public class GetRequiringBundles {
	...
	/**
	 * Creates a new GetRequiringBundle
	 * 
	 * @param _control the bundle control for this test
	 */
	public GetRequiringBundles(TestControl _control) {
		control = _control;
	}
	...
	public void run() throws Exception {
		testGetRequiringBundle0001();
		testGetRequiringBundle0002();
	}

	/**
	 * Check the invocation with a started required bundle
	 */
	public void testGetRequiringBundle0001() throws Exception {
		Bundle[] bundles;
	 ...
	 */
	public void testGetRequiringBundle0002() throws Exception {
		PackageAdmin packageAdmin;
		RequiredBundle[] requiredBundles;
		ServiceReference serviceReference;
