...
import org.osgi.test.cases.jndi.secure.service.ExampleService;
...
public class TestServiceIntegration extends DefaultTestBundleControl {
	...
	public void testMultipleServiceLookup() throws Exception {
		...
		try {
			...
			serviceListContext = (Context) ctx
					.lookup("osgi:servicelist/org.osgi.test.cases.jndi.secure.service.ExampleService");
