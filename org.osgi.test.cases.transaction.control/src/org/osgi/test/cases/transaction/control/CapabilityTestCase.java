...
public class CapabilityTestCase extends TxControlTestCase {
	...
	public void testTxControlServiceCapability() throws Exception {
		...
		List<BundleCapability> capabilities = txControlBundle
		...
		for (Capability cap : capabilities) {
			...
			if (objectClass.contains(TransactionControl.class.getName())) {
				hasCapability = true;
				...
				if (usesDirective != null) {
					...
					uses = packages
							.contains("org.osgi.service.transaction.control");
				}
				break;
			}
		}
