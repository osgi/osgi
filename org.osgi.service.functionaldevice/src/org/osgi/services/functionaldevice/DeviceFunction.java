...
/**
 * The device function provides specific device operations and properties. Each
 ...
 * 
 * <p>
 * Operation arguments share the same metadata with the device function
 * properties. The data type can be one of the following types:
 * <ul>
 ...
 * {@link #META_INFO_PROPERTY_ACCESS} meta data key. The device function
 * properties can be accessed in three ways. Any combinations between them are
 * possible:
 * <ul>
 * <li>
 * {@link #META_INFO_PROPERTY_ACCESS_READABLE} - available for all properties,
 * which can be read. The device function must provide a getter method for an
 * access to the property value.</li>
 * <li>
 * {@link #META_INFO_PROPERTY_ACCESS_WRITABLE} - available for all properties,
 * which can be modified. The device function must provide a setter method for a
...
public interface DeviceFunction {
	 ...
	 * access mandates the device function to provide a property getter method.
	 */
	 ...
	 * access mandates the device function to provide a property setter method.
	 */
