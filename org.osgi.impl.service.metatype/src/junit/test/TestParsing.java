...
import org.osgi.impl.service.metatype.MTI;
...
public class TestParsing extends TestCase {
	...
	public void testParser() throws Exception {
		TestBundle	tb = new TestBundle();
		
		MTI mti = new MTI(tb, "bundle" );
		mti.parseMetaData(getClass().getResource("testfile.xml"));
