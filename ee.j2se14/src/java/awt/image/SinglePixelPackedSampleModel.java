...
public class SinglePixelPackedSampleModel extends java.awt.image.SampleModel {
	public SinglePixelPackedSampleModel(int var0, int var1, int var2, int var3, int[] var4) { super(0, 0, 0, 0); }
	public SinglePixelPackedSampleModel(int var0, int var1, int var2, int[] var3) { super(0, 0, 0, 0); }
	...
	public int[] getBitMasks() { return null; }
	public int[] getBitOffsets() { return null; }
