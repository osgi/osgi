...
//  ********************     HttpConfig     ********************
/**
 ** The HttpConfig class holds all the configuration for the
 ** web server, e.g. mime types and ports to use.
 ** <p>
 ** The classes is declares abstract and contain a set of 
 ** static fields and methods for getting configuration values and
 ** properties.
 ** 
...
public final class HttpConfig  {
  ...
  public static boolean useErrorTrailer = true;		// Add a stylish trailer at the end of an error response
