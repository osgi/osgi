 ...
 ** <li>Registering the HttpService. The service is registered as a service factory,
...
public class HttpServiceController implements BundleActivator, ServiceFactory
{
  ...
  private HttpServer httpServer;		// The actual HttpServer
  private Hashtable services = new Hashtable();	// Maps <bundleId> -> HttpServiceImpl
  private ServiceRegistration httpReg;		// The registration of the HttpService
  ...
  public void start(BundleContext bc) throws BundleException {
    ...
    try {
      ...
      httpReg = bc.registerService("org.osgi.service.http.HttpService", this, dict);

      // Register a default page
      HttpService httpService = (HttpService)bc.getService(httpReg.getReference());
