 ...
 ** Instances of this class is created by the service factory and
 ** handed to the clients requesting the HttpService.
 **
...
public final class HttpServiceImpl implements HttpService {
  ...
  public HttpServiceImpl(HttpServer httpServer, BundleContext bc, Bundle bundle) {
  ...
  {
    if (closed)
      throw new IllegalStateException("Service has been unget and is closed");
    if (context == null)
      context = createDefaultHttpContext();
    log.info("Registering resource with alias : " + alias);
    httpServer.addRegistration(new ResourceRegistration(this, alias, name, context));
  }
	   ...
	   IllegalArgumentException
  {
    ...
    try {
      reg = new ServletRegistration(this,
                                    alias,
                                    servlet,
                                    initparams,
                                    context,
  ...
  //  ====================     unregister     ====================
  /**
   ** Implements unregister(). If service is closed request is
   ** silently ignored.
   ** @see HttpService#registerServlet
   */
  public void unregister(String alias) {
    ...
    if (reg == null) {
      throw new IllegalArgumentException("Cannot unregister non existing alias: " + alias);
    }
    ...
    if (this != reg.serviceImpl) {
      ...
      throw new IllegalArgumentException("Calling bundle did not register this alias: " + alias);
    }
