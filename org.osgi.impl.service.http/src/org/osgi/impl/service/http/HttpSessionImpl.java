...
public final class HttpSessionImpl implements HttpSession {
  ...
  public HttpSessionImpl(ServletEngine servletEngine, AliasRegistration reg, String sessionId) {
  ...
  public void removeValue (String name) {
    ...
    if (tmp != null && tmp instanceof HttpSessionBindingListener)
      ((HttpSessionBindingListener)tmp).valueUnbound(new HttpSessionBindingEvent(this, name));
  }
