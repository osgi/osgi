...
public class MethodCall {
     ...
     */
    public MethodCall(Class clazz, String name, Class paramClass, Object paramObject) {
		this(clazz,name);
     ...
     */
    public MethodCall(Class clazz, String name, Class[] paramClasses, Object[] paramObjects) {
		this(clazz,name );
