...
package org.osgi.test.cases.framework.classloading.tb4c;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		srs = context.getAllServiceReferences(SomeService.class.getName(),
				"(version=*)");
		
		try {
			if (srs.length != 2) {
				throw new BundleException(
						"The method getAllServiceReferences does not return the number of services as expected");
			}
		}
		finally {
