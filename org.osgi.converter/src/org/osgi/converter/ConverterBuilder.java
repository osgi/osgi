...
/**
 * A builder to create a new converter with modified behaviour based on an existing
...
public interface ConverterBuilder {
     ...
     * @return This converter builder for further building.
     */
    <F, T> ConverterBuilder rule(TypeReference<F> fromRef, TypeReference<T> toRef,
            Function<F,T> toFun,
            Function<T,F> fromFun);
