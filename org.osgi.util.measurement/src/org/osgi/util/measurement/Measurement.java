 ...
 * 
 * <p>
 * A <tt>Measurement</tt> object is immutable in order to be easily shared.
 * 
 * <p>
...
public class Measurement implements Comparable {
	 ...
	 * 
	 * The format of the string must be: <value>':' <unit>[ ':' error ]
	 ...
	 * @param unit The <tt>Unit</tt> object in which the value is measured. If
	 *        this argument is <tt>null</tt>, then the unit will be set to
	 *        {@link Unit#unity}.
	...
	/**
	 * Create a new <tt>Measurement</tt> object with an error of 0.0 and a
	 * time of zero.
	 * 
	 * @param value The value of the <tt>Measurement</tt>.
	 * @param unit The <tt>Unit</tt> in which the value is measured. If this
	 *        argument is <tt>null</tt>, then the unit will be set to
	 *        {@link Unit#unity}.
	 */
	...
	/**
	 * Create a new <tt>Measurement</tt> object with an error of 0.0, a unit
	...
	/**
	 * Returns the error of this <tt>Measurement</tt> object. The error is
	 ...
	 * 
	 * @return The time at which this <tt>Measurement</tt> object was taken or
	 *         zero.
	 */
	...
	/**
	 * Returns a new <tt>Measurement</tt> object that is the product of this
	 * object multiplied by the specified object.
	 * 
	 * @param m The <tt>Measurement</tt> object that will be multiplied with
	 *        this object.
	 * @return A new <tt>Measurement</tt> that is the product of this object
	 ...
	 *         time of this object.
	 * @throws ArithmeticException If the <tt>Unit</tt> objects of this object
	 ...
	 * @return A new <tt>Measurement</tt> object that is the product of this
	...
	/**
	 * Returns a new <tt>Measurement</tt> object that is the quotient of this
	 * object divided by the specified object.
	 * 
	 * @param m The <tt>Measurement</tt> object that will be the divisor of
	 *        this object.
	 * @return A new <tt>Measurement</tt> object that is the quotient of this
	 ...
	 * @return A new <tt>Measurement</tt> that is the quotient of this object
	 ...
	 *         object is computed. The unit and time of the new object is set to
	 *         the <tt>Unit</tt> and time of this object.
	 */
	...
	/**
	 * Returns a new <tt>Measurement</tt> object that is the sum of this
	 ...
	 * 
	 * @param m The <tt>Measurement</tt> object that will be added with this
	 *        object.
	 * @return A new <tt>Measurement</tt> object that is the sum of this and
	 *         m.
	 * @see Unit
	 * @throws ArithmeticException If the <tt>Unit</tt> objects of this object
	 ...
	 * @param u The <tt>Unit</tt> object of the specified value.
	 * @return A new <tt>Measurement</tt> object that is the sum of this
	 ...
	 *         the new object is set to the error, <tt>Unit</tt> and time of
	 *         this object.
	 */
	...
	/**
	 * Returns a new <tt>Measurement</tt> object that is the subtraction of
	 * the specified object from this object.
	 * 
	 * @param m The <tt>Measurement</tt> object that will be subtracted from
	 *        this object.
	 * @return A new <tt>Measurement</tt> object that is the subtraction of
	 ...
	 *         the new object is set to the error, <tt>Unit</tt> object and
	 *         time of this object.
	 */
	...
	/**
	 * Returns a <tt>String</tt> object representing this <tt>Measurement</tt>
	 * object.
	 * 
	 * @return a <tt>String</tt> object representing this <tt>Measurement</tt>
	 *         object.
	 */
	 ...
	 * For this method, another <tt>Measurement</tt> object is considered
	 * equal if there is some <tt>x</tt> such that
	 * 
	 * <pre>
	 ...
	 *         <tt>Measurement</tt> object is not equal to the <tt>Unit</tt>
	 ...
	 * <tt>Measurement</tt> objects are equal if they have same value, error
	 * and <tt>Unit</tt>.
	 * 
	 * <p>
	 * Note: This class has a natural ordering that is inconsistent with equals.
