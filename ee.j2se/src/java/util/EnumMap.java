...
public class EnumMap<K extends java.lang.Enum<K>,V> extends java.util.AbstractMap<K,V> implements java.io.Serializable, java.lang.Cloneable {
	public EnumMap(java.lang.Class<K> var0) { } 
	public EnumMap(java.util.EnumMap<K,? extends V> var0) { } 
	public EnumMap(java.util.Map<K,? extends V> var0) { } 
	public java.util.EnumMap<K,V> clone() { return null; }
