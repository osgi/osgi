...
public class ArrayBlockingQueue<E> extends java.util.AbstractQueue<E> implements java.io.Serializable, java.util.concurrent.BlockingQueue<E> {
	public ArrayBlockingQueue(int var0) { } 
	public ArrayBlockingQueue(int var0, boolean var1) { } 
	public ArrayBlockingQueue(int var0, boolean var1, java.util.Collection<? extends E> var2) { } 
