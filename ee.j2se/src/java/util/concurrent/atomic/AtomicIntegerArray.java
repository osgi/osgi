...
public class AtomicIntegerArray implements java.io.Serializable {
	public AtomicIntegerArray(int var0) { } 
	public AtomicIntegerArray(int[] var0) { } 
	public final int addAndGet(int var0, int var1) { return 0; }
	public final boolean compareAndSet(int var0, int var1, int var2) { return false; }
	public final int decrementAndGet(int var0) { return 0; }
	public final int get(int var0) { return 0; }
	public final int getAndAdd(int var0, int var1) { return 0; }
	public final int getAndDecrement(int var0) { return 0; }
