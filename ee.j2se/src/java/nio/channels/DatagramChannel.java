...
public abstract class DatagramChannel extends java.nio.channels.spi.AbstractSelectableChannel implements java.nio.channels.ByteChannel, java.nio.channels.GatheringByteChannel, java.nio.channels.MulticastChannel, java.nio.channels.ScatteringByteChannel {
	...
	public abstract java.nio.channels.DatagramChannel bind(java.net.SocketAddress var0) throws java.io.IOException;
	...
	public static java.nio.channels.DatagramChannel open(java.net.ProtocolFamily var0) throws java.io.IOException { return null; }
	...
	public abstract <T> java.nio.channels.DatagramChannel setOption(java.net.SocketOption<T> var0, T var1) throws java.io.IOException;
