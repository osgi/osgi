...
public class MultiPixelPackedSampleModel extends java.awt.image.SampleModel {
	public MultiPixelPackedSampleModel(int var0, int var1, int var2, int var3) { super(0, 0, 0, 0); }
	public MultiPixelPackedSampleModel(int var0, int var1, int var2, int var3, int var4, int var5) { super(0, 0, 0, 0); }
	...
	public int getBitOffset(int var0) { return 0; }
	public int getDataBitOffset() { return 0; }
	...
	public int getPixelBitStride() { return 0; }
	public int getSample(int var0, int var1, int var2, java.awt.image.DataBuffer var3) { return 0; }
	public int[] getSampleSize() { return null; }
	public int getSampleSize(int var0) { return 0; }
	public int getScanlineStride() { return 0; }
