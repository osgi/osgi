...
public interface ThreadMXBean extends java.lang.management.PlatformManagedObject {
	...
	int getThreadCount();
	long getThreadCpuTime(long var0);
	...
	void setThreadContentionMonitoringEnabled(boolean var0);
	void setThreadCpuTimeEnabled(boolean var0);
}
