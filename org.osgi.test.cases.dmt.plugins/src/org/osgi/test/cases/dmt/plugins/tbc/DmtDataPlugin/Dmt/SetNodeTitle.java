 ...
 * 
 * @methodUnderTest org.osgi.service.dmt.Dmt#setNodeTitle
 * @generalDescription This Test Case Validates the implementation of
 *                     <code>setNodeTitle<code> method, according to MEG reference
...
public class SetNodeTitle {
	...
	private void testSetNodeTitle001() {
		...
		try {
			...
			tbc.assertEquals("Asserts that DmtAdmin fowarded "+ TestDataPlugin.SETNODETITLE+" to the correct plugin",TestDataPlugin.SETNODETITLE,DmtTestControl.TEMPORARY);
			tbc.assertEquals("Asserts that DmtAdmin the parameter was fowarded to the correct plugin without modification",title,DmtTestControl.PARAMETER_2);
		} catch (Exception e) {
	...
	/**
	 * @testID testSetNodeTitle002
	 * @testDescription Forces a DmtException in order to check if Dmt#setNodeTitle
