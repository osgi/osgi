...
public class NewDataPluginActivator implements BundleActivator {
	...
	public static final String TEST_NEW_DATA_PLUGIN_ROOT = "./OSGi/test/new_data_plugin";
	
	public static final String INEXISTENT_NODE = TEST_NEW_DATA_PLUGIN_ROOT +"/inexistent";
	...
	public void start(BundleContext bc) throws Exception {
		...
		props.put("dataRootURIs", new String[] { TEST_NEW_DATA_PLUGIN_ROOT });
