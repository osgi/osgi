...
public class FatalExceptionDataPlugin implements DmtDataPlugin {
	...
	public void createInteriorNode(String nodeUri, String type)
			throws DmtException {
		throw new DmtException(nodeUri,DmtException.OTHER_ERROR,null,null,true);
	}
	...
	public boolean isNodeUri(String nodeUri) {
		if (nodeUri.equals(FatalExceptionDataPluginActivator.INEXISTENT_NODE)) {
			return false;
		} else {
			return true;
		}
	...
	public String getNodeType(String nodeUri) throws DmtException {
		throw new DmtException(nodeUri,DmtException.OTHER_ERROR,null);
	}
