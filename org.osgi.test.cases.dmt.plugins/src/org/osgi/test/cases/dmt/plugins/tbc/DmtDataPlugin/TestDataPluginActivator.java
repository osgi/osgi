...
public class TestDataPluginActivator implements BundleActivator {
	...
	public static final String TEST_DATA_PLUGIN_ROOT = "./OSGi/test/data_plugin";
	
	public static final String TEST_DATA_PLUGIN_ROOT2 = "./OSGi/test/data_plugin_2";
	
	public static final String INEXISTENT_NODE = TEST_DATA_PLUGIN_ROOT +"/inexistent";
	
	public static final String INEXISTENT_NODE_EXCEPTION = TEST_DATA_PLUGIN_ROOT +"/inex_exception";
	
	public static final String INTERIOR_NODE = TEST_DATA_PLUGIN_ROOT +"/interior";
	...
	public static final String INTERIOR_NODE_EXCEPTION = TEST_DATA_PLUGIN_ROOT + "/exception";
	
	public static final String INTERIOR_NODE_EXCEPTION2 = TEST_DATA_PLUGIN_ROOT + "/exception2";
	
	public static final String INTERIOR_NODE_EXCEPTION3 = TEST_DATA_PLUGIN_ROOT + "/exception3";
	...
	public void start(BundleContext bc) throws Exception {
		...
		props.put("dataRootURIs", new String[] { TEST_DATA_PLUGIN_ROOT, TEST_DATA_PLUGIN_ROOT2 });
