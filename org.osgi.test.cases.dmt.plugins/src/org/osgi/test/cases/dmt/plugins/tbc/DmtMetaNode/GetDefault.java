...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#getDefault
 * @generalDescription This class tests DmtMetaNode.getDefault method according
...
public class GetDefault {
	...
	/**
	 * @testId testGetDefault001
	 * @testDescription Gets the Default Data defined on the TestPlugin and
	 *                  asserts that DmtAdmin forwards the correct values to the
	 *                  session.
	 */
