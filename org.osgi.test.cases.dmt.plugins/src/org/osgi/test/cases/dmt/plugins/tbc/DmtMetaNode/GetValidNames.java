...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#getValidNames
 * @generalDescription This class tests DmtMetaNode.getValidNames method
...
public class GetValidNames {
	...
	/**
	 * @testID testGetValidNames001
	 * @testDescription Test whether getValidNames method returns the value
	...
	private void testGetValidNames001() {
		...
		try {
			...
			tbc.assertEquals("Asserts getValidNames method",
