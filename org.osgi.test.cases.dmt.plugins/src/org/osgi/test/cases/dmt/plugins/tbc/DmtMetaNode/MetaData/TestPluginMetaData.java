 ...
 * 
 */
public class TestPluginMetaData implements DmtDataPlugin {
	//DmtReadOnly
	...
	public boolean isNodeUri(String nodeUri) {
		if (nodeUri.equals(TestPluginMetaDataActivator.INEXISTENT_NODE) 
				|| nodeUri.equals(TestPluginMetaDataActivator.INEXISTENT_LEAF_NODE) 
				|| nodeUri.equals(TestPluginMetaDataActivator.INEXISTENT_LEAF_NODE_INVALID_NAME)
				|| nodeUri.equals(TestPluginMetaDataActivator.INEXISTENT_NODE_INVALID_NAME)) { 
			return false;
		} else {
			return true;
		}
	...
	public boolean isLeafNode(String nodeUri) throws DmtException {
		if (nodeUri.equals(TestPluginMetaDataActivator.LEAF_NODE) || nodeUri.equals(TestPluginMetaDataActivator.INEXISTENT_LEAF_NODE_INVALID_NAME)) {
			return true; 
		}
		else {
			return false;
