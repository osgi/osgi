...
/**
 * Test the method org.osgi.framework.Version.getQualifier().
 * 
 * @version $Revision$
 */
public class GetQualifier {
	...
	public void run() throws Exception {
		testGetQualifier0001();
		testGetQualifier0002();
	}
	...
	public void testGetQualifier0001() throws Exception {
		...
		if (!version.getQualifier().equals("a")) {
