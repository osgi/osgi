...
/**
 * 
 * This class tests the method org.osgi.framework.BundleException.initCause().
 * 
 * @version $Revision$
 */
public class InitCause {
	...
	public void testInitCause0001() throws Exception {
		...
		try {
			bundleException.initCause(exception);
			throw new BundleExceptionTestException(
					"Testing the method initCause");
		}
