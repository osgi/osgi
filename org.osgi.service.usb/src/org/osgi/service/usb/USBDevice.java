...
public interface /* org.osgi.service.usb. */USBDevice {
	 ...
	 * 
	 * The value is Integer, the 4-digit BCD format. Example: 0x0210
	 */
	 ...
	 * 
	 * The value is Integer, hexadecimal, 2-digits. Example: 0xff
	 */
	 ...
	 * 
	 * The value is Integer, hexadecimal, 4-digits. Example: 0x0403
	 */
	 ...
	 * 
	 * The value is Integer, hexadecimal, 4-digits. Example: 0x8372
	 */
	 ...
	 * 
	 * The value is Integer, the 4-digit BCD format. Example: 0x0200
	 */
	...
	/**
	 * MANDATORY property key. Value is "USB.device.interfaceclasses".
	 * 
	 * The property value is Integer[], hexadecimal, 6-digits. Each Integer
	 * responds to each USB interface and is combined the interface's
	 * bInterfaceClass (2-digits), bInterfaceSubClass (2-digits) and
	 * bInterfaceProtocol (2-digits). Example: {0x080000, 0x0a00ff}
	 */
	static final String INTERFACE_CLASSES = "USB.device.interfaceclasses";
	 ...
	 * device. USB bus ID is integer (001-127).
	 * 
