...
package org.osgi.test.cases.syncbundlelistener.tb4;
        ...
        try
        {
			if (fe.getBundle()!=bc.getBundle())
			{
				...
				case BundleEvent.INSTALLED:
                	_link.log("BundleListener: INSTALLED", "This asynclistener should be called after the synchronous");
                	break;
				
				case BundleEvent.STARTED:
                	_link.log("BundleListener: STARTED.", "This asynclistener should be called after the synchronous");
                	break;
				
				case BundleEvent.STOPPED:
                	_link.log("BundleListener: STOPPED.", "This asynclistener should be called after the synchronous");
                	break;
				
				case BundleEvent.UNINSTALLED:
                	_link.log("BundleListener: UNINSTALLED .", "This asynclistener should be called after the synchronous");
                	break;
				
				case BundleEvent.UPDATED:
                	_link.log("BundleListener: UPDATED.", "This asynclistener should be called after the synchronous");
                	break;	
				}				
            }
		}
