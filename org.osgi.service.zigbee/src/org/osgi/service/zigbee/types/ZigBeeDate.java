 ...
 */
public class ZigBeeDate implements ZCLDataTypeDescription {

	private static ZigBeeDate	singletonInstance	= new ZigBeeDate();
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.DATE, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.DATE, data);
	}
}
