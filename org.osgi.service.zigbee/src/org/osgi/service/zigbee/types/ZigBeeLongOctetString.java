 ...
 */
public class ZigBeeLongOctetString implements ZCLDataTypeDescription {

	private static ZigBeeLongOctetString	singletonInstance	= new ZigBeeLongOctetString();

	private ZigBeeLongOctetString() {
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.LONG_OCTET_STRING, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.LONG_OCTET_STRING, data);
	}
}
