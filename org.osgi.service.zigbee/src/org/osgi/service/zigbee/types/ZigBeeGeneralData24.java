 ...
 */
public class ZigBeeGeneralData24 implements ZCLDataTypeDescription {
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.GENERAL_DATA_24, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.GENERAL_DATA_24, data);
	}
}
