 ...
 */
public class ZigBeeEnumeration8 implements ZCLDataTypeDescription {
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.ENUMERATION_8, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.ENUMERATION_8, data);
	}
}
