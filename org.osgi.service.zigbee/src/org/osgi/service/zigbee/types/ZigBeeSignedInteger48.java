 ...
 */
public class ZigBeeSignedInteger48 implements ZCLDataTypeDescription {
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.SIGNED_INTEGER_48, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.SIGNED_INTEGER_48, data);
	}
}
