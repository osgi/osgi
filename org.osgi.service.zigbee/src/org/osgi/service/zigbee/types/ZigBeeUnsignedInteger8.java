...
/**
 * This interface represents a ZigBeeUnsignedInteger8 as described in the ZigBee
 * Specification.
 * 
 * @version 1.0
 */
public class ZigBeeUnsignedInteger8 implements ZigBeeDataTypeDescription {

	private static ZigBeeUnsignedInteger8	singletonInstance	= new ZigBeeUnsignedInteger8();

	private ZigBeeUnsignedInteger8() {
