 ...
 */
public class ZigBeeTimeOfDay implements ZCLDataTypeDescription {
	...
	public void serialize(Object param, ByteArrayOutputStream outdata) {
		ZigBeeDataTypes.encode(ZigBeeDataTypes.TIME_OF_DAY, param, outdata);
	}

	public Object deserialize(ByteArrayInputStream data) {
		return ZigBeeDataTypes.decode(ZigBeeDataTypes.TIME_OF_DAY, data);
	}
}
