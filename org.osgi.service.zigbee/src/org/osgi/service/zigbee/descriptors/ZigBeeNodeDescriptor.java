...
public interface ZigBeeNodeDescriptor {
	...
	/**
	 * @return one of: ZigBeeDeviceNode.COORDINATOR, ZigBeeDeviceNode.ROUTER, ZigBeeDeviceNode.END_DEVICE.
	 */
	...
	/**
	 * @return an int corresponding to the 5 bits which indicate the frequency range. use the frequency mask constants to get info, which are the ranges actually supported.
	 */
	...
	/**
	 * @return true if this node is capable of becoming PAN coordinator or false otherwise.
	 */
	...
	/**
	 * @return true if the current power source is mains power or false otherwise.
	 */
	public boolean isMainsPower();
	
	/**
	 * @return true if the device does not disable its receiver to conserve power during idle periods or false otherwise.
	 */
	public boolean isReceiverOnWhenIdle();
	
	/**
	 * @return true if the device is capable of sending and receiving secured frames or false otherwise.
	 */
	...
	/**
	 * @return true if extended active endpoint list is available or false otherwise.
	 */
	public boolean isExtendedActiveEndpointListAvailable();
	
	/**
	 * @return true if extended simple descriptor is available or false otherwise.
	 */
