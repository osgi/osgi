...
public class KPI {
	 ...
	 * 
	 * @param cm Collection method, should be one of the CM_ constants
	 * @param data The value of the KPI. The type of the object should be
	 *        supported by the Configuration Admin
	 */
	 ...
	 * Monitorable. A KPI names must not contain a '/' character.
	 * 
	 ...
	 * @throws java.lang.UnsupportedOperationException if the type of KPI is not
	 *         string
	 */
	...
	/**
	 * Returns the KPI value if it's type is Object. All types supported by the
	 * OSGi Configuration Admin service can be used. Exact type information can
	 * be queried using getClass().getName()
	 * 
