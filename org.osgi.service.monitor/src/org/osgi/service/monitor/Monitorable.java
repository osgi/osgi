...
public interface Monitorable {
	...
	/**
	 * Returns the {@code StatusVariable} object addressed by its identifier.
	 * The {@code StatusVariable} will hold the value taken at the time of this
	 * method call.
	 * <p>
	 ...
	 * notifications when the given {@code StatusVariable} changes. If the
	 * {@code Monitorable} supports sending change updates it must notify the
	 * {@code MonitorListener} when the value of the {@code StatusVariable}
	 * changes. The {@code Monitorable} finds the {@code MonitorListener}
	 ...
	 * @param id the identifier of the {@code StatusVariable}, cannot be
	 *        {@code null}
	 * @return {@code true} if the {@code Monitorable} can send notification
	 *         when the given {@code StatusVariable} changes, {@code false}
	 *         otherwise
	 * @throws java.lang.IllegalArgumentException if {@code id} points to a
	 *         non-existing {@code StatusVariable}
	 */
	 ...
	 * example a {@code StatusVariable} of type {@code String} might not have a
	 * meaningful default value. Note that for numeric {@code StatusVariables}
	 * the starting value may not necessarily be 0. Resetting a
	 * {@code StatusVariable} must trigger a monitor event.
	 * <p>
	 * The given identifier does not contain the Monitorable PID, i.e. it
	 * specifies the name and not the path of the Status Variable.
	 * 
	 ...
	 * can be used by management systems on their GUI. The {@code null} return
