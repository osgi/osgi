...
public interface MonitorAdmin {
	...
	/**
	 * Starts a Monitoring Job with the parameters provided. In case of
	 * successful starting of a job the MonitorAdmin generates the appropriate
	 * event. If the list of KPI names contains a non existing KPI or the
	 * schedule or count parameters are invalid then IllegalArgumentException is
	 * thrown.
	 * 
	 ...
	 */
	public MonitoringJob startJob(String[] kpis, int schedule, int count)
			throws IllegalArgumentException;
