...
public class HttpWhiteboardTestBundle1 implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_RESOURCE_PREFIX, "/org/osgi/test/cases/servlet/tb1/resources");
		serviceRegistrations.add(
		...
		properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_RESOURCE_PREFIX, "/org/osgi/test/cases/servlet/tb1/resources/resource1.txt");
		serviceRegistrations.add(
				context.registerService(Object.class, new Object(), properties));
	}
