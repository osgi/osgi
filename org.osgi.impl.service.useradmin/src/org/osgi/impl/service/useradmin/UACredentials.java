 ...
 * deleting values.  
 * <p> 
 * User credentials are instances of this class. Changes to these objects
 ...
 * <p>
 * A {@link UserAdminPermission} with the action <code>getCredential</code>
 * is required to getting dictionary values, and the action
