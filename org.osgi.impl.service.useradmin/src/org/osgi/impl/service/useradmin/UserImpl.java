...
public class UserImpl extends RoleImpl implements User {
  ...
  /**
   * Gets the credentials of this role. 
   * Implementation of {@link org.osgi.service.useradmin.User#getCredentials}.
   */
  ...
  /**
   * Checks if this user has the specified credential.
   * Implementation of {@link org.osgi.service.useradmin.User#hasCredential}.
   */
  public boolean hasCredential(String key, Object value) {
    ...
    if (value instanceof String) {
      ...
      return rvalue instanceof byte[] && Arrays.equals((byte[])value, (byte[])rvalue);
    } else
