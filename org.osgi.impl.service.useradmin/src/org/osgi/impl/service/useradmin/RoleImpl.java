...
public class RoleImpl implements Role {
   ...
   * Implementation of {@link org.osgi.service.useradmin.Role#getName}.
   */
   ...
   * Implementation of {@link org.osgi.service.useradmin.Role#getType}.
   */
  public int getType() {
    return type;
  }
   ...
   * Implementation of {@link org.osgi.service.useradmin.Role#getProperties}.
   */
  ...
  protected boolean impliedBy(AuthorizationImpl auth) {
    ...
    boolean implied = 
      (rolename != null && rolename.equals(name)) || 
