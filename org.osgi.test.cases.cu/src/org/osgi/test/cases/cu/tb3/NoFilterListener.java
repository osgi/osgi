...
/**
 * Listener of state variable changes registered without filter.
 * This listener will recieve all events.
 * 
 * @version $Revision$
 */
public class NoFilterListener implements StateVariableListener {
	...
	public void stateVariableChanged(String controlUnitType,
		...
		Activator.log("<NoFilterListener> Type = " + controlUnitType + ", Id = " + controlUnitId + ", varId = " + varId + ", value = " + value);
	}
}
