...
public interface ConfigurationAdmin {
	 ...
	 * <ul>
	 * <li>{@code service.pid}-{@code String}- the PID under which this is
	 * registered</li>
	 * <li>{@code service.factoryPid}-{@code String}- the factory if applicable</li>
	 * <li>{@code service.bundleLocation}-{@code String}- the bundle location</li>
	 * </ul>
