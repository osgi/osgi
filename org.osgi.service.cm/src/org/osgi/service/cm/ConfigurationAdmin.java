...
public interface ConfigurationAdmin {
	 ...
	 *         <tt>AdminPermission</tt> and <tt>factoryPid</tt> is bound to
	 *         another bundle.
	 */
	 ...
	 * @throws IOException if access to persistent storage fails.
	 * @throws SecurityException if the <tt>Configuration</tt> object is bound
	 *         to a location different from that of the calling bundle and it
	 *         has no <tt>AdminPermission</tt>.
	 */
	 ...
	 * 
	 * @param filter a <tt>Filter</tt> object, or <tt>null</tt> to retrieve
	 *        all <tt>Configuration</tt> objects.
