...
public class DiscoveryMsgCreator {
  ...
  public DatagramPacket createAlive(String nt, String usn, String location, String cachecontrol) {
    return createAlive(nt, usn, location, cachecontrol, UPnPConstants.V_NTS_A);
  }
  
  public DatagramPacket createAlive(String nt, String usn, String location, String cachecontrol, String nts) {
    return createAlive (nt, usn, location, cachecontrol, nts, UPnPConstants.V_MC_HOST);
  }
  
  public DatagramPacket createAlive(String nt, String usn, String location, String cachecontrol, String nts, String host) {
    return createAlive(nt, usn, location, cachecontrol, nts, host, UPnPConstants.V_SERVER, 0);
  }
  
  public DatagramPacket createAlive(String nt, String usn, String location, String cachecontrol, String nts, String host, String server, int err) {
    ...
    buf.append(UPnPConstants.CRLF); // emptry line at the end of the discovery
  ...
  public DatagramPacket createByeBye (String nt, String usn, String nts, String host) {
    StringBuffer buf = new StringBuffer();
    buf.append(UPnPConstants.MC_NOTIFY);
