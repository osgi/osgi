...
public class EventSender implements Runnable {
  ...
  public void run () {
    ...
    hash.put(UPnPConstants.N_HEX, Hex.encode(UPnPConstants.V_HEX.getBytes()));
    ...
    logger.log ("Sending an event with name " + UPnPConstants.N_CHAR + " and value " + UPnPConstants.V_CHAR);

    if(sid.indexOf("e") >= 0) {
      hash.put(UPnPConstants.N_INT, UPnPConstants.V_INT);
      logger.log ("Sending an event with name " + UPnPConstants.N_INT + " and value " + UPnPConstants.V_INT);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      hash.put(UPnPConstants.N_UI4, UPnPConstants.V_UI4);
      logger.log ("Sending an event with name " +  UPnPConstants.N_UI4 + " and value " + UPnPConstants.V_UI4);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      hash.put(UPnPConstants.N_NUMBER, duble);
      logger.log ("Sending an event with name " + UPnPConstants.N_NUMBER + " and value " + UPnPConstants.V_NUMBER);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      hash.put(UPnPConstants.N_FLOAT, fl);
      logger.log ("Sending an event with name " + UPnPConstants.N_FLOAT + " and value " + UPnPConstants.V_FLOAT);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      hash.put(UPnPConstants.N_STRING, UPnPConstants.V_STRING);
      logger.log ("Sending an event with name " + UPnPConstants.N_STRING + " and value " + UPnPConstants.V_STRING);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      hash.put(UPnPConstants.N_BOOLEAN, UPnPConstants.V_BOOLEAN);
      logger.log ("Sending an event with name " + UPnPConstants.N_BOOLEAN + " and value " + UPnPConstants.V_BOOLEAN);
      try {
        genEvent(hash, 0);
      } catch(IOException exc) {
        exc.printStackTrace();
      ...
      try {
        hash.put(UPnPConstants.N_HEX, Hex.encode(UPnPConstants.V_HEX.getBytes()));
        logger.log ("Sending an event with name " + UPnPConstants.N_HEX + " and value " + UPnPConstants.V_HEX);
      } catch(Exception exc) {
...
//    System.out.println("CLIENT: Sending event for sid: " + sid);
    ...
    Socket sock = new Socket(loc.getHost(), loc.getPort() == -1 ? 80 : loc.getPort());
