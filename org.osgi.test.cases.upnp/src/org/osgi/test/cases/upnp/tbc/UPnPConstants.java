...
public final class UPnPConstants {
  ...
  //ids
  public static String UDN_RCD = "uuid:prosyst-com:rcd:";//r continues device
  public static String UDN_RBD = "uuid:prosyst-com:rbd:";//r bye device
  public static String UDN_RNBD = "uuid:prosyst-com:rnbd:";//r no bye device
  public static String UDN_WLD = "uuid:prosyst-com:wld:";//w location device
  public static String UDN_WND = "uuid:prosyst-com:wnd:";//w nts device
  public static String UDN_WCCLD = "uuid:prosyst-com:wccld:";//w cache-control letter device
  public static String UDN_WCCND = "uuid:prosyst-com:wccnd:";//w cache-control negative device
  public static String UDN_WADS = "uuid:prosyst-com:wads:";//w advertisement devices
