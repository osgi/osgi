...
public class EventServer implements Runnable {
  ...
  public EventServer (String host, int port, BundleContext bc, DefaultTestBundleControl control) throws Exception {
    ...
    try {
      ...
      if (ll != null) {
        if (ll.equals("HTTP/1.1 200 OK")) {
          control.log("HTTP/1.1 200 OK msg as reply to subsribe msg is received");
          listRef = bc.getServiceReference("org.osgi.service.upnp.UPnPEventListener");
