...
public class BlueprintEvent {
	 ...
	 *            associated with this event. Must not be <code>null</code>
	 ...
	 * <code>BlueprintEvent</code>. The <code>timestamp</code> property
	 * will be copied from the original event and only the replay property will
	 * be overridden with the given value.
	 * 
	 * @param event
	 *            The original <code>BlueprintEvent</code> to copy, must not
	 *            be <code>null</code>.
	 * @param replay
