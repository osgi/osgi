...
public class IOControl extends DefaultTestBundleControl {
	...
	public void testOpen() throws Exception {
		...
		ServiceRegistration reg = bc.registerService(ConnectionFactory.class.getName(), cf, props);
		
		ServiceTracker st = new ServiceTracker(bc, ConnectorService.class.getName(), null);
		st.open();
	...
	public void testRanking1() throws Exception {
		...
		ServiceRegistration reg1 = bc.registerService(ConnectionFactory.class.getName(), cf1, props);
		TestConnectionFactory cf2 = new TestConnectionFactory();
		ServiceRegistration reg2 = bc.registerService(ConnectionFactory.class.getName(), cf2, props);
	...
	/**
	 * checks if the ConnectionFactory with the highest service ranking is choosen
	 * @throws Exception
	 */
