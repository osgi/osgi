 ...
 * @since 1.4
 */
interface TBundleTrackerCustomizer<S> {
	/**
	 ...
	 * {@link TBundleTracker#getObject(Bundle) getObject} method.
	 * 
	 ...
	 */
	S addingBundle(TBundle bundle, TBundleEvent event);
	 ...
	 */
	void modifiedBundle(TBundle bundle, TBundleEvent event,
			S object);
	 ...
	 * @param object The tracked object for the specified bundle.
	 */
	void removedBundle(TBundle bundle, TBundleEvent event,
			S object);
}
