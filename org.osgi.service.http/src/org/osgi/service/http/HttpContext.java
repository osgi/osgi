 ...
 * 
 * <p>
 * Servlets and resources may be registered with an <tt>HttpContext</tt>
 * object; if no <tt>HttpContext</tt> object is specified, a default
 * <tt>HttpContext</tt> object is used. Servlets that are registered using the
 * same <tt>HttpContext</tt> object will share the same
 * <tt>ServletContext</tt> object.
 * 
 * <p>
 * This interface is implemented by users of the <tt>HttpService</tt>.
 * 
 * @version $Revision$
 */
public abstract interface HttpContext {
	 ...
	 * <tt>HttpServletRequest.getRemoteUser</tt>. This attribute name is
	 ...
	 * <tt>org.osgi.service.useradmin.UserAdmin</tt> service. The value of the
	 * attribute can be retrieved by
	 * <tt>HttpServletRequest.getAttribute(HttpContext.AUTHORIZATION)</tt>.
	 * This attribute name is <tt>org.osgi.service.useradmin.authorization</tt>.
	 * 
	 * @since 1.1
	 */
	 ...
	 * response object to Unauthorized(401) and return <tt>false</tt>. See
	 ...
	 * 
	 * <p>
	 * If the request requires a secure connection and the <tt>getScheme</tt>
	 ...
	 * object to Forbidden(403) and return <tt>false</tt>.
	 * 
	 * <p>
	 * When this method returns <tt>false</tt>, the Http Service will send
	 * the response back to the client, thereby completing the request. When
	 * this method returns <tt>true</tt>, the Http Service will proceed with
	 ...
	 * <tt>getAuthType</tt> and <tt>getRemoteUser</tt> methods,
	 * respectively, on the request.
	 * 
	 * @param request the HTTP request
	 * @param response the HTTP response
	 * @return <tt>true</tt> if the request should be serviced, <tt>false</tt>
	 ...
	 * <tt>ServletContext</tt> methods <tt>getResource</tt> and
	 * <tt>getResourceAsStream</tt>. For resource registrations, Http Service
	 ...
	 * <tt>bundleContext.getDataFile(name).toURL()</tt> or to a resource in
	 * the context's bundle via <tt>getClass().getResource(name)</tt>
	 * 
	 ...
	 * the <tt>ServletContext</tt> method <tt>getMimeType</tt>. For
	 ...
	 * @return MIME type (e.g. text/html) of the name or <tt>null</tt> to
