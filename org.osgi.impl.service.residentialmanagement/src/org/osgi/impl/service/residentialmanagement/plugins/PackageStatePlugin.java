 ...
 */
public class PackageStatePlugin implements DataPlugin {
    private PackageStateReadOnlySession readonly;
    
    PackageStatePlugin(BundleContext context) {
    	readonly = new PackageStateReadOnlySession(this, context);
    }
