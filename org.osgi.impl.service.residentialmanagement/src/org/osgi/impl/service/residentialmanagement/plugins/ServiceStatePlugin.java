 ...
 */
public class ServiceStatePlugin implements DataPlugin {
    private ServiceStateReadOnlySession readonly;
    
    ServiceStatePlugin(BundleContext context) {
    	readonly = new ServiceStateReadOnlySession(this, context);
    }
