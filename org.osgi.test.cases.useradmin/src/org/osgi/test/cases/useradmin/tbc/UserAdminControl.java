...
public class UserAdminControl extends DefaultTestBundleControl {
    ...
    static String[] methods = new String[] {
        ...
        "testGetUser",
        "testRoleGetType",
        "testRoleChangeProperties",
        "testRolePutProperties",
        "testRoleGetName",
        "testUserChangeCredentials",
        "testUserPutCredentials",
        "testUserHasCredential",
        "testGroupAddMember",
        "testGroupAddRequiredMembers",
        "testGroupGetMembers",
        "testGroupGetRequiredMembers",
        "testGroupRemoveMember",
        "testUserAnyone",
        "testBasicRequired",
        "testRequiredAuth",
        "testUserAnyoneBasic",
        "testUserAnyoneRequired",
        "testAnonymousUser",
        "testGroupInGroup",
        "testUserAdminEvents"
    };
    ...
    public void testGetUser() throws Exception {
        ...
        log("getUser", roleToString(useradmin.getUser("unexisting-key", "foobar")));
    ...
    public void testUserHasCredential() throws Exception {
        ...
        log("hasCredential", "" + user.hasCredential("pwd2", new byte[]{0,0,0}));
    }
    ...
    public void testUserAdminEvents() {
        ...
        RoleListener roleListener = 
        	new RoleListener(this, semaphore, UserAdminEvent.ROLE_REMOVED);
	...
	public void logRoles(String testText, Role[] roles)
		    throws IOException {
		...
		if (roles != null) {
            ...
            /* The order of the roles isn't specified, so 
               we better sort them. */
    ...
    void logPuts(String testText, Dictionary dictionary, Object[][] keysAndValues) {
    ...
    void clearAllRoles() throws Exception {
        ...
        if(roles == null) {
            ...
            throw new RuntimeException("Can not remove all roles needed for testing");
        }
        else if(!roles[0].getName().equals("user.anyone")) {
            logRoles("Incorrect roles", roles);
            throw new RuntimeException("Can not remove all needed for testing");
        }
    }
    ...
    String eventTypeToString(int type) {
        ...
        switch(type) {
            case 1  : typeString = "ROLE_CREATED"; break;
            case 2  : typeString = "ROLE_CHANGED"; break;
            case 4  : typeString = "ROLE_REMOVED"; break;
