 ...
 */
package org.osgi.test.cases.composite.tb4client2;
...
public class Tb4Client implements BundleActivator {
	...
	public void start(BundleContext context) {
		...
		ServiceReference ref = context.getServiceReference(SomeService2.class.getName());
		if (ref == null)
		...
		SomeService2 service = (SomeService2) context.getService(ref);
		if (service == null)
