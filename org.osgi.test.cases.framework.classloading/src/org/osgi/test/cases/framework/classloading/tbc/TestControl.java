 ...
 */
package org.osgi.test.cases.framework.classloading.tbc;
...
public class TestControl extends DefaultTestBundleControl {
	...
	public void testBundleContextGetReference001() throws Exception {
		...
		tb1a.start();
		tb1b = installBundle("tb1b.jar");
		tb1b.start();

		tb4a = getContext().installBundle(getWebServer() + "tb4a.jar");
		try {
	...
	public void testBundleContextGetReference002() throws Exception {
		...
		tb4b = getContext().installBundle(getWebServer() + "tb4b.jar");
		try {
	...
	public void testBundleContextGetAllServiceReferences001() throws Exception {
		...
		tb4c = getContext().installBundle(getWebServer() + "tb4c.jar");
		try {
	...
	public void testBundleContextIsAssignableTo001() throws Exception {
		...
		tb4d = getContext().installBundle(getWebServer() + "tb4d.jar");
		try {
	...
	public void testBundleContextIsAssignableTo002() throws Exception {
		...
		tb4e = getContext().installBundle(getWebServer() + "tb4e.jar");
		try {
	...
	public void testServiceRegistryWithMultipleServices001() throws Exception {
		...
		try {
			...
			tb4f = getContext().installBundle(getWebServer() + "tb4f.jar");
			tb1a = installBundle("tb1a.jar");
			tb1a.start();
			tb4f.start();
			tb4f.stop();
			...
			trace("Checking if the correct service is imported");
			tb4g = getContext().installBundle(getWebServer() + "tb4g.jar");
			tb2a = installBundle("tb2a.jar");
			tb2a.start();
			tb4g.start();
			tb4g.stop();
			tb2a.stop();
	...
	public void testServiceListener001() throws Exception {
		...
		tb5a = getContext().installBundle(getWebServer() + "tb5a.jar");
		try {
			tb5a.start();
	...
	public void testServiceListener002() throws Exception {
		...
		tb5b = getContext().installBundle(getWebServer() + "tb5b.jar");
		try {
			tb5b.start();
	...
	public void testAllServiceListener001() throws Exception {
		...
		tb5c = getContext().installBundle(getWebServer() + "tb5c.jar");
		try {
			tb5c.start();
	...
	public void testPermissionChecking001() throws Exception {
		...
		tb1 = installBundle("tb1.jar");
		tb1.start();
		tb6a = installBundle("tb6a.jar");
		tb6a.start();
		tb6b = installBundle("tb6b.jar");
		tb6b.start();
		tb6c = installBundle("tb6c.jar");
		tb6c.start();

		tb6d = installBundle("tb6d.jar");
		try {
	...
	public void testJavaPackageExplicityExportImport001() {
		...
		try {
			...
			tb7a = getContext().installBundle(getWebServer() + "tb7a.jar");
			tb7a.uninstall();
		...
		try {
			...
			tb7b = getContext().installBundle(getWebServer() + "tb7b.jar");
			tb7b.uninstall();
	...
	public void testClassLoadingSearchOrder001() throws Exception {
		...
		tb8a = installBundle("tb8a.jar");
		tb8b = installBundle("tb8b.jar");
		tb8c = installBundle("tb8c.jar");

		try {
			tb8d = installBundle("tb8d.jar");
	...
	public void testClassLoadingSearchOrder002() throws Exception {
		...
		try {
			...
			try {
				assertEquals("Checking the bundle name", "tb8a", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testClassLoadingSearchOrder003() throws Exception {
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the bundle name", "tb8b", reader
						.readLine());
			}
			finally {
				reader.close();
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the bundle name", "tb8e", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testClassLoadingSearchOrder005() throws Exception {
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the bundle name", "tb8c", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testClassLoadingSearchOrder006() throws Exception {
		...
		tb9a = installBundle("tb9a.jar");

		tb9b = installBundle("tb9b.jar");
		try {
			// The loading class must be loaded by the parent class loader
	...
	public void testClassLoadingSearchOrder007() throws Exception {
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the bundle name", "tb9a", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testBundleModule001() throws Exception {
		...
		try {
			...
			url = new URL(getWebServer() + "tb1.jar");
			inputStream = url.openStream();
	...
	public void testSingletonBundle001() throws Exception {
		...
		tb11b = getContext().installBundle(getWebServer() + "tb11b.jar");
		tb11c = getContext().installBundle(getWebServer() + "tb11c.jar");
		tb11d = getContext().installBundle(getWebServer() + "tb11d.jar");
	...
	public void testBundleInstall001() throws Exception {
		...
		try {
			...
			tb12b = getContext().installBundle(getWebServer() + "tb12b.jar");
			tb12b.uninstall();
	...
	public void testPackageExport001() throws Exception {
		...
		try {
			...
			tb13a = installBundle("tb13a.jar");

			tb13o = installBundle("tb13o.jar");
			tb13p = installBundle("tb13p.jar");
	...
	public void testPackageExport002() throws Exception {
		...
		tb8a = getContext().installBundle(getWebServer() + "tb8a.jar");
		tb8b = getContext().installBundle(getWebServer() + "tb8b.jar");
		tb8a.start();
		tb8b.start();

		tb13b = getContext().installBundle(getWebServer() + "tb13b.jar");
		tb13c = getContext().installBundle(getWebServer() + "tb13c.jar");
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the loading bundle name", "tb8b", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testPackageExport003() throws Exception {
		...
		tb13d = getContext().installBundle(getWebServer() + "tb13d.jar");
		tb13c = getContext().installBundle(getWebServer() + "tb13c.jar");
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the loading bundle name", "tb8a", reader
						.readLine());
			}
			finally {
				reader.close();
	...
	public void testPackageExport004() throws Exception {
		...
		tb13e = getContext().installBundle(getWebServer() + "tb13e.jar");
		tb13f = getContext().installBundle(getWebServer() + "tb13f.jar");
	...
	public void testPackageExport005() throws Exception {
		...
		tb13g = installBundle("tb13g.jar");
		tb13h = installBundle("tb13h.jar");
	...
	public void testPackageExport006() throws Exception {
		...
		tb13g = installBundle("tb13g.jar");
		tb13i = getContext().installBundle(getWebServer() + "tb13i.jar");
	...
	public void testPackageExport008() throws Exception {
		...
		try {
			tb13k = getContext().installBundle(getWebServer() + "tb13k.jar");
			tb13k.uninstall();
		}
		catch (BundleException ex) {
		...
		try {
			...
			tb13l = getContext().installBundle(getWebServer() + "tb13l.jar");
			tb13l.uninstall();
	...
	/**
	 * Test the attribuets bundle-symbolic-name and bundle-version.
	 * 
	...
	public void testPackageExport009() throws Exception {
		...
		try {
			...
			tb13m = getContext().installBundle(getWebServer() + "tb13m.jar");
			tb13m.uninstall();
	...
	public void testPackageImport001() throws Exception {
		...
		tb8a = installBundle("tb8a.jar");
		tb15a = installBundle("tb15a.jar");

		try {
			// Install a bundle which import packages
			tb15b = getContext().installBundle(getWebServer() + "tb15b.jar");
			...
			reader = new BufferedReader(new InputStreamReader(inputStream));
			try {
				assertEquals("Checking the loading bundle name", "tb15a",
						reader.readLine());
			}
			finally {
				reader.close();
	...
	public void testPackageImport002() throws Exception {
		...
		tb15c = getContext().installBundle(getWebServer() + "tb15c.jar");
	...
	public void testPackageImport003() throws Exception {
		...
		// Try to install when the imported package is not available
		tb15d = getContext().installBundle(getWebServer() + "tb15d.jar");
	...
	public void testPackageImport004() throws Exception {
		...
		try {
			...
			try {
				tb15e = getContext()
						.installBundle(getWebServer() + "tb15e.jar");
				tb15e.uninstall();
			}
			catch (BundleException ex) {
			...
			try {
				...
				tb15f = getContext()
						.installBundle(getWebServer() + "tb15f.jar");
				tb15f.uninstall();
	...
	public void testPackageImport005() throws Exception {
		...
		tb1 = installBundle("tb1.jar");
		tb15g = getContext().installBundle(getWebServer() + "tb15g.jar");
	...
	public void testPackageDynamicImport005() throws Exception {
		...
		try {
			...
			tb17e = getContext().installBundle(getWebServer() + "tb17e.jar");
			tb17e.uninstall();
	...
	public void testRequiredBundle001() throws Exception {
		...
		Bundle tb16c = getContext().installBundle(getWebServer() + "tb16c.jar");
		Bundle tb16a = getContext().installBundle(getWebServer() + "tb16a.jar");
		tb16b.start();
		tb16c.start();
		tb16a.start();
	...
	public void testRequiredBundle004() throws Exception {
		Bundle tb16b = getContext().installBundle(getWebServer() + "tb16b.jar");
		Bundle tb16a = getContext().installBundle(getWebServer() + "tb16k.jar");
		Bundle tb16i = getContext().installBundle(getWebServer() + "tb16i.jar");
		tb16a.start();
		tb16b.start();
		tb16i.start();
		try {
	...
	public void testRequiredBundle005() throws Exception {
		...
		Bundle tb16e = getContext().installBundle(getWebServer() + "tb16e.jar");
	...
	public void testRequiredBundle006() throws Exception {
		...
		// Install and start requiring bundle
		Bundle tb16f = getContext().installBundle(getWebServer() + "tb16f.jar");
	...
	public void testRequiredBundle007() throws Exception {
		Bundle tb16b = getContext().installBundle(getWebServer() + "tb16b.jar");
		tb16b.start();
		Bundle tb16g = getContext().installBundle(getWebServer() + "tb16g.jar");
		tb16g.start();
	...
	public void testRequiredBundle008() throws Exception {
		...
		tb16h = getContext().installBundle(getWebServer() + "tb16h.jar");
		tb16h.start();
	...
	public void testRequiredBundle010() throws Exception {
		Bundle tb16b = getContext().installBundle(getWebServer() + "tb16b.jar");
		Bundle tb16c = getContext().installBundle(getWebServer() + "tb16c.jar");
		Bundle tb16a = getContext().installBundle(getWebServer() + "tb16j.jar");
		tb16b.start();
		tb16c.start();
		tb16a.start();
		URL url = tb16a.getResource("test/package/resources/resource.txt");
