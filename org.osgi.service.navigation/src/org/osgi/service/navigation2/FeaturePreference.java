...
public class FeaturePreference 
{
    ...
    */
   public static final FeaturePreference PREFER_HIGHWAY = new FeaturePreference (false);

   /**
    * FeaturePreference object to set HIGHWAY preference.
    */
   public static final FeaturePreference AVOID_HIGHWAY = new FeaturePreference (true);
   
   /**
    * FeaturePreference object to set TOLLWAY preference.
    */
   public static final FeaturePreference PREFER_TOLLWAY = new FeaturePreference (false);
   
   /**
    * FeaturePreference object to set TOLLWAY preference.
    */
   public static final FeaturePreference AVOID_TOLLWAY = new FeaturePreference (true);
   
   /**
    * FeaturePreference object to set FERRY preference.
    */
   public static final FeaturePreference PREFER_FERRY = new FeaturePreference (false);
   /**
    * FeaturePreference object to set FERRY preference.
    */
   public static final FeaturePreference AVOID_FERRY = new FeaturePreference (true);
   
   
   public static final FeaturePreference FASTEST = new FeaturePreference(false);
   public static final FeaturePreference SHORTEST = new FeaturePreference(false);
   /**
