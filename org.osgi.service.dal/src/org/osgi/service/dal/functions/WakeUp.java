...
/**
 * <code>WakeUp</code> Device Function provides device awake monitoring and
 * management. It's especially applicable to battery-operated devices. Such
 * device can notify the system that it's awake and can receive commands with an
 * event to property {@link #PROPERTY_AWAKE}.
 * <p>
 ...
 * @see BooleanData
 */
public interface WakeUp extends DeviceFunction {
