 ...
 * 
 * <p>
 * <tt>WireAdminEvent</tt> objects are delivered to all registered
 * <tt>WireAdminListener</tt> service objects which specify an interest in the
 * <tt>WireAdminEvent</tt> type. Events must be delivered in chronological
 * order with respect to each listener. For example, a <tt>WireAdminEvent</tt>
 * of type {@link #WIRE_CONNECTED}must be delivered before a
 * <tt>WireAdminEvent</tt> of type {@link #WIRE_DISCONNECTED}for a particular
 * <tt>Wire</tt> object.
 * 
 * <p>
 ...
 * <p>
 * Security Considerations. <tt>WireAdminEvent</tt> objects contain
 * <tt>Wire</tt> objects. Care must be taken in the sharing of <tt>Wire</tt>
...
public class WireAdminEvent {
	 ...
	 * 
	 * <p>
	 * This <tt>WireAdminEvent</tt> type indicates that a Producer service
	 ...
	 * 
	 * <p>
	 * The value of <tt>PRODUCER_EXCEPTION</tt> is 0x00000001.
	 */
	 ...
	 * 
	 * <p>
	 * This <tt>WireAdminEvent</tt> type indicates that a Consumer service
	 * method has thrown an exception. The {@link WireAdminEvent#getThrowable}
	 * method will return the exception that the Consumer service method raised.
	 * 
	 * <p>
	 * The value of <tt>CONSUMER_EXCEPTION</tt> is 0x00000002.
	 */
	 ...
	 * 
	 * <p>
	 * This <tt>WireAdminEvent</tt> type that indicates that a new
	 * <tt>Wire</tt> object has been created.
	 * 
	 * An event is broadcast when {@link WireAdmin#createWire}is called. The
	 * {@link WireAdminEvent#getWire}method will return the <tt>Wire</tt>
	 * object that has just been created.
	 * 
	 * <p>
	 * The value of <tt>WIRE_CREATED</tt> is 0x00000004.
	 */
	 ...
	 * 
	 * <p>
	 * This <tt>WireAdminEvent</tt> type that indicates that an existing
	 * <tt>Wire</tt> object has been updated with new properties.
	 * 
	 ...
	 * <tt>Wire</tt> object that has just been updated.
	 * 
	 * <p>
	 * The value of <tt>WIRE_UPDATED</tt> is 0x00000008.
	 */
	 ...
	 * 
	 * <p>
	 * The value of <tt>WIRE_DISCONNECTED</tt> is 0x00000040.
	 */
	public final static int		WIRE_DISCONNECTED	= 0x00000040;
	/**
	 * The <tt>WireAdminEvent</tt> type that indicates that a new value is
	 * transferred over the <tt>Wire</tt> object.
	 * 
	 ...
	 * 
	 * <p>
	 * The value of <tt>WIRE_TRACE</tt> is 0x00000080.
	 */
	public final static int		WIRE_TRACE			= 0x00000080;

	/**
	 * Constructs a <tt>WireAdminEvent</tt> object from the given
	 * <tt>ServiceReference</tt> object, event type, <tt>Wire</tt> object
	 * and exception.
	 * 
	 * @param reference The <tt>ServiceReference</tt> object of the Wire Admin
	 ...
	 *        <tt>null</tt> if no exception is associated with this event.
	 */
	...
	/**
	 * Return the <tt>ServiceReference</tt> object of the Wire Admin service
	 * that created this event.
	 * 
	 * @return The <tt>ServiceReference</tt> object for the Wire Admin service
	 *         that created this event.
	 */
	 ...
	 * 
	 * @return The <tt>Wire</tt> object associated with this event or
	 *         <tt>null</tt> when no <tt>Wire</tt> object is associated with
	 *         the event.
	 */
	public Wire getWire() {
		return wire;
	 ...
	 * 
	 * @return An exception or <tt>null</tt> if no exception is associated
	 *         with this event.
	 */
