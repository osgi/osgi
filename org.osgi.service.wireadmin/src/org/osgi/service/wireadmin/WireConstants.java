...
/**
 * Defines standard names for <tt>Wire</tt> properties, wire filter
...
public interface WireConstants {
	/**
	 * <tt>Wire</tt> property key (named <tt>wireadmin.pid</tt>) specifying
	 * the persistent identity (PID) of this <tt>Wire</tt> object.
	 * 
	 * <p>
	 * Each <tt>Wire</tt> object has a PID to allow unique and persistent
	 * identification of a specific <tt>Wire</tt> object. The PID must be
	 * generated by the {@link WireAdmin}service when the <tt>Wire</tt>
	 * object is created.
	 * 
	 * <p>
	 * This wire property is automatically set by the Wire Admin service. The
	 * value of the property must be of type <tt>String</tt>.
	 */
	 ...
	 * <tt>wireadmin.producer.scope</tt>) specifying a list of names that may
	 * be used to define the scope of this <tt>Wire</tt> object. A Producer
	 ...
	 * modifying the property must not have any effect of the <tt>Wire</tt>
	 * object's scope. Each name in the given list mist have
	 * <tt>WirePermission[PRODUCE,name]</tt> or else is ignored. The type of
	...
	/**
	 * Service registration property key (named
	 * <tt>wireadmin.consumer.scope</tt>) specifying a list of names that may
	 * be used to define the scope of this <tt>Wire</tt> object. A
	 * <tt>Consumer</tt> service should set this service property when it can
	 ...
	 * <tt>Wire</tt> object's scope. Each name in the given list mist have
	 * <tt>WirePermission[CONSUME]</tt> or else is ignored. The type of this
	 * service registration property must be <tt>String[]</tt>.
	 * 
	 * @see Wire#getScope
	 ...
	 * 
	 * <p>
	 * This property should contain a filter as described in the <tt>Filter</tt>
	 ...
	 * Producer service will perform the data filtering then the <tt>Wire</tt>
	 * object will not perform data filtering. Otherwise, the <tt>Wire</tt>
	...
	/**
	 * <tt>Wire</tt> object's filter attribute (named
	 * <tt>wirevalue.current</tt>) representing the current value.
	 */
	public final static String	WIREVALUE_CURRENT				= "wirevalue.current";
	/**
	 * <tt>Wire</tt> object's filter attribute (named
	 * <tt>wirevalue.previous</tt>) representing the previous value.
	 */
	public final static String	WIREVALUE_PREVIOUS				= "wirevalue.previous";
	/**
	 * <tt>Wire</tt> object's filter attribute (named
	 * <tt>wirevalue.delta.absolute</tt>) representing the absolute delta.
	...
	/**
	 * <tt>Wire</tt> object's filter attribute (named
	 * <tt>wirevalue.delta.relative</tt>) representing the relative delta.
	 * The relative difference is |<tt>previous</tt>-<tt>current</tt> |/|
	 * <tt>current</tt>| (only when numeric). This attribute must not be used
	 * when the values are not numeric.
	 */
	public final static String	WIREVALUE_DELTA_RELATIVE		= "wirevalue.delta.relative";
	/**
	 * <tt>Wire</tt> object's filter attribute (named
	 * <tt>wirevalue.elapsed</tt>) representing the elapsed time, in ms,
	 * between this filter evaluation and the last update of the
	 * <tt>Consumer</tt> service.
	 */
	public final static String	WIREVALUE_ELAPSED				= "wirevalue.elapsed";
	/* Service registration property key names. */
	/**
	 * Service Registration property (named <tt>wireadmin.producer.filters</tt>).
	 * A <tt>Producer</tt> service registered with this property indicates to
	 ...
	 * Producer service is not registered with this property, the <tt>Wire</tt>
	...
	/**
	 * Service Registration property (named <tt>wireadmin.consumer.flavors</tt>)
	...
	/**
	 * Service Registration property (named <tt>wireadmin.producer.flavors</tt>)
	...
	/**
	 * Service Registration property (named <tt>wireadmin.events</tt>)
	 * specifying the <tt>WireAdminEvent</tt> type of interest to a Wire Admin
	 * Listener service. The value of the property is a bitwise OR of all the
	 * <tt>WireAdminEvent</tt> types the Wire Admin Listener service wishes to
	 * receive and must be of type <tt>Integer</tt>.
	 * 
	 * @see WireAdminEvent
	 */
