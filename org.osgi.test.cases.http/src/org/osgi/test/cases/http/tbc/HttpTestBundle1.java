		...
		BundleActivator, Runnable
{
	...
	static String[] methods = new String[]
	{
		...
		"Empty_doGet",  				// "TC50"
		"Security", 					// "TC51"
		// "doGetExceptions",  			// "TC52" Disabled due to undefined behavior
		"LargeOutput",  				// "TC53"
	...
	public void SimpleServletRegistration () throws Exception
	{
		...
		_http.registerServlet ("/tc1servlet",
			servlet,
			null,
			httpContext);
	...
	public void SimpleServletUnregistration () throws Exception
	{
		...
		_http.registerServlet ("/tc2servlet",
			servlet,
			null,
			httpContext);
		log ("Simple servlet registered");
		...
		try
		{
			in = new BufferedReader (new InputStreamReader(source.openStream()));
			// read lines in resource /tc2servlet
			while ((inputLine = in.readLine()) != null) {log(inputLine);}
			in.close ();
		}
		catch (IOException e)
		{
	...
	public void OverlappingRegistrationPaths () throws Exception
	{
		...
		final String	  urlstr_aa 	= "http://localhost:" +
			_httpPort +
			"/aa?TestCase=3";
		final String	  urlstr_aabb   = "http://localhost:" +
			_httpPort +
			"/aa/bb?TestCase=3";
		URL 			  source_aa 	= null;
	...
	public void BundleStopping () throws Exception
	{
		...
		Bundle tb2 = getContext().installBundle( "BundleStoppingHelperBundle", getClass().getResourceAsStream("/tb1.jar") );
	...
	public void LongRegistrationName () throws Exception
	{
		...
		_http.registerServlet ("",
			servlet,
			null,
			httpContext);
		...
		_http.unregister ("");
	...
	public void NullServlet () throws Exception
	{
		...
		try
		{
			_http.registerServlet("/tc7servlet",
				servlet,
				null,
				httpContext);
	...
	public void CaseSensitivity () throws Exception
	{
		...
		final String	  urlstr_lc   = "http://localhost:" +
			_httpPort +
			"/aa?TestCase=8";
		final String	  urlstr_UC   = "http://localhost:" +
			_httpPort +
			"/AA?TestCase=8";
		String  		  inputLine   = new String();
		StringBuffer	  resbuf	  = new StringBuffer();
	...
	public void GenericServletRegistration () throws Exception
	{
		...
		_http.registerServlet("/tc9servlet",
			servlet,
			null,
			httpContext);
	...
	public void RegisterResources () throws Exception
	{
		...
		final String	res1url   = "http://localhost:" +
			_httpPort +
			"/tc10resource/tc10.html";
		final String	res2url   = "http://localhost:" +
			_httpPort +
		...
		_http.registerResources ("/tc10resource",
			"www",
			httpContext);
	...
	public void MultipleRegistrations () throws Exception
	{
		...
		_http.registerResources("/tc11resource",
			"www",
			httpContext);
	...
	public void MultipleUnregistrations () throws Exception
	{
		...
		_http.registerResources("/tc12resource",
			"www",
			httpContext);
		log("Resource registered");
	...
	public void EndingSlash () throws Exception
	{
		...
		try
		{
			...
			_http.registerResources("/tc13resource/",
				"www",
				httpContext);
			log("Resource registered");
		}
	...
	public void ServletRegDefaultContext () throws Exception
	{
		...
		_http.registerServlet ("/tc15servlet",
			servlet,
			null,
			null);
	...
	public void ResourceRegDefaultContext () throws Exception
	{
		...
		_http.registerResources ("/tc16resource",
			"org/osgi/test/cases/http/tbc/www",
			null);
		log ("Resource registered");
	...
	public void RegisterMultipleAliases () throws Exception
	{
		...
		try
		{
			_http.registerServlet("/tc17a",
				servlet,
				null,
				httpContext);
			log("Servlet registered with path tc17a");
			
			_http.registerServlet("/tc17b",
				servlet,
				null,
				httpContext);
	...
	public void Empty_doGet () throws Exception
	{
		...
		_http.registerServlet("/tc50servlet",
			servlet,
			null,
			httpContext);
        ...
        // Disable keep alive for this connection to prevent the URLConnection from having
	...
	public void Security () throws Exception
	{
		...
		HttpContext hc2 = new HttpContext ()
		{
			...
			{
				// Handle security for a request.
				response.setHeader ("WWW-Authenticate", "Basic realm=\"Some Realm\"");
		...
		try
		{
			_http.registerServlet ("/tc51servlet",
				servlet,
				null,
				hc1);
		...
		try
		{
			...
			while ((inputLine = in2.readLine ()) != null) {resbuf.append (inputLine);}
			log (resbuf.toString ());
		}
	...
	/**
	 * This test seems to be nonsense because
	 * exceptions thrown in a servlet do not have a
	 * defined result in the output. It could send
	 * the stream so far or it could append it with
	 * the error message. This test is disabled for now.
	 */
	public void doGetExceptions () throws Exception
	{
		...
		_http.registerServlet ("/tc52servlet",
			servlet,
			null,
			httpContext);
	...
	public void LargeOutput () throws Exception
	{
		...
		_http.registerServlet("/tc53servlet",
			servlet,
			null,
			httpContext);
	...
	public void HangRequest () throws Exception
	{
		...
		try
		{
			_http.registerServlet ("/tc55servlet",
				servlet,
				null,
				httpContext);
		...
		Runnable requestThread = new Runnable ()
		{
			public void run ()
			{
				...
				try
				{
					...
					while ((inputLine2 = in.readLine()) != null) {resbuf2.append(inputLine2);}
		...
		try
		{
			in2 = new BufferedReader(new InputStreamReader(source2.openStream()));
	...
	public void LargeURL () throws Exception
	{
		...
		_http.registerServlet ("/tc56servlet",
			servlet,
			null,
			httpContext);
	...
	public void OddURL () throws Exception
	{
		...
		_http.registerServlet ("/tc57servlet",
			servlet,
			null,
			httpContext);
	...
	public void MultipleNamesURL () throws Exception
	{
		...
		_http.registerServlet ("/tc58aservlet",
			servlet,
			null,
			httpContext);
	...
	public void MultipleNamesURL2 () throws Exception
	{
		...
		_http.registerServlet ("/tc58bservlet",
			servlet,
			null,
			httpContext);
		log ("Servlet accessed with different values for the same parameter registered");
	...
	public void MIMEtypes () throws Exception
	{
		...
		HttpTestServlet1  servlet   = new HttpTestServlet1 ();
		final String	  urlstr1   = "http://localhost:" +
			_httpPort +
			"/tc59servlet?TestCase=59&type=plain";
		final String	  urlstr2   = "http://localhost:" +
			_httpPort +
			"/tc59servlet?TestCase=59&type=html";
		final String	  urlstr3   = "http://localhost:" +
			_httpPort +
		...
		_http.registerServlet ("/tc59servlet",
			servlet,
			null,
			httpContext);
	...
	public void ResourceName () throws Exception
	{
		...
		_http.registerServlet ("/dir1/dir2/tc60servlet",
			servlet,
			null,
			httpContext);
	...
	public void Authentication () throws Exception
	{
		...
		try
		{
			_http.registerServlet ("/tc61servlet",
				servlet,
				null,
				new HttpContext()
				{
					public boolean handleSecurity(HttpServletRequest request, HttpServletResponse response) throws IOException {
						log("Handle Security Called");
						request.setAttribute(HttpContext.REMOTE_USER,"unknown user");
	...
	public void ServletContextSharing () throws Exception
	{
		...
		try
		{
			_http.registerServlet ("/tc62servlet1",
				servlet1,
				null,
				hc1);
			log ("Servlet1 registered");
			
			_http.registerServlet ("/tc62servlet2",
				servlet2,
				null,
				hc1);
			log ("Servlet2 registered");
			
			_http.registerServlet ("/tc62servlet3",
				servlet3,
				null,
				hc2);
