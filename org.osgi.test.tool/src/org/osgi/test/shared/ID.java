...
/**
	The ID class implements a logical representation/name
	of a java object. It can be used to hand out to
	other processes. For this reason, it implements 
	equality/hashCode.
*/
...
public class ID implements Serializable
{
	...
	public int hashCode() { return getTitle().hashCode(); }
