...
/**
    ...
    This class is used in several places to handle send/receive
    problems between processes.
*/
...
public class Queue {
    ...
    /**
        Add a new element to the queue, if there
        are waiters notify them.
    ...
    */
    ...
    /**
        Wait for an object to be pushed for 
