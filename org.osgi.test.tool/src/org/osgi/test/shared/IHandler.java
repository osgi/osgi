...
public interface IHandler  {
	/**
		Option logging. This means that no comparisons
		are made, only the raw bundle output is send
		to the applet. value = 0x0001
	*/
	public final static int OPTION_LOGGING  	= 0x0001;
	
	/**
		Option debug. Send debug messages to the console
		to see the progress. value = 0x0002
	*/
