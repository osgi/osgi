...
/**
    The Shadow class is a helper for making a shadow
    registry of the Framework registry. It maintains
    a list of services from the framework but it allows
    the user to wrap an object around it. This class
    handles (or at least is supposed to handle) the tricky
    multithreading issues of coming and going services.
    <p>Normally this class is extended with a domain
    specific class.
*/
public abstract class Shadow implements ServiceListener  {
    BundleContext           _context;       // Framework context
    Hashtable               _wrappers = new Hashtable();    // ServiceReference -> Object wrapper
    ...
    */
    public void open( BundleContext context, Class clazz, String filter ) throws InvalidSyntaxException
    {
        if ( filter == null )
        ...
        synchronized( this )
        {
            ...
            ServiceReference ref[] = _context.getServiceReferences( _clazz.getName(), _filter );
    ...
    */
    public synchronized void serviceChanged( ServiceEvent event )
    {
        ...
        {
        case ServiceEvent.REGISTERED:      add( ref ); break;
        case ServiceEvent.MODIFIED:        modified( ref );  break;                
        case ServiceEvent.UNREGISTERING:   remove( ref ); break;
        }
    }
    ...
    */
    protected void remove( ServiceReference ref )
    {
        ...
        if ( association != null )
        {
            ...
            System.out.println( "Trying to remove non existent reference " + ref );
    }
    ...
    */      
    ...
    /**
        Get the wrapper from the reference, must be 
    ...
    */
    ...
    /**
        Release the wrapper. Can be overridden by the
        subclass to do clean up. Default is do nothing.
    ...
    */
    ...
    /**
        Indicate changed registry, can be overridden by subclass.
    ...
    */
    ...
    /**
        Answer the size of the list, notice that this
        size can change any time.
    */
    public int size() { return _wrappers.size(); }
