...
/**
	...
	A remote service is a reference to a host:port
	pair somewhere on the net.
*/
	...
	implements RemoteService
{
	...
	*/
	public RemoteServiceImpl( String application, String host, int port, String comment ) {
	...
	public void update()			{ modified = System.currentTimeMillis(); }
	public String toString()		{ return application + ":" + host + ":" + port + " " + comment; }
	public String getID()   		{ return toString(); }
	public int hashCode()   		{ return application.hashCode() ^ host.hashCode() ^ port; }
	...
	static public boolean isLocal(RemoteService rs) {
		if ( localif == null )
			try { localif = InetAddress.getByName( "127.0.0.1" ); } catch( Exception e ) {
				e.printStackTrace();
			};
