...
public class FailedEndpointDTO extends FailedDTO {
	...
	/**
	 * There are matching handlers for this endpoint but setting a handler chain
	 * is not supported. This may be done to avoid any overriding of a
	 * pre-configured handler chain.
	 **/
