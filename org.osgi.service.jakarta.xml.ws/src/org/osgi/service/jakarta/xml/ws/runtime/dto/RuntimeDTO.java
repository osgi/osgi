...
public class RuntimeDTO extends DTO {
	...
	/**
	 * Returns all handlers that are known and bound to an endpoint, the
	 * returned array may be empty.
	 */
	public HandlerDTO[]			handlers;

	/**
	 * Returns all handlers that are known but not currently bound to an
	 * endpoint, the returned array may be empty.
	 */
