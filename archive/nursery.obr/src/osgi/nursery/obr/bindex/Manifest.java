...
public class Manifest extends Hashtable {
	...
	List<Entry> getEntries(String line) throws IOException {
		List<Entry> v = new Vector<Entry>();
	...
	public List<Entry> getImports() {
		return imports;
	}

	public List<Entry> getExports() {
		return exports;
	}
	...
	public String getSymbolicName() {
		...
		if (bsn == null) {
			...
			if (name == null)
				throw new IllegalArgumentException("No name for bundle");
			return name;
		}
		else
			return bsn.getName();
