		...
		private boolean compare(Object obj, int op, String s) {
			...
			try {
				...
				if (numClass == String.class) {
					...
					try {
						Constructor constructor = numClass.getConstructor(new Class[] {String.class} );
						Object instance = constructor.newInstance( new Object[] { s } );
						switch( op ) {
							case EQ: return obj.equals(instance);
							case LESS: return ((Comparable)obj).compareTo(instance) < 0;
							case GREATER: return ((Comparable)obj).compareTo(instance) > 0;
							case LE: return ((Comparable)obj).compareTo(instance) <= 0;
							case GE: return ((Comparable)obj).compareTo(instance) >= 0;
						}
					} catch( Exception e ) {
						// Ignore
					}
