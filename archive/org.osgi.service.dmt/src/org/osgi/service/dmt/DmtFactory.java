...
public interface DmtFactory {
   ...
   public DmtSession getTree(DmtPrincipal principal, String subtreeUri) throws DmtException;
	/** @modelguid {3470D158-BA2E-4782-9DD7-84F71F1A8A9A} */
   public DmtSession getTree(DmtPrincipal principal, String subtreeUri, int lockMode) throws DmtException;
}
