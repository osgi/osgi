 ...
 * the list of root node URIs in a String array in the <code>dataRootURIs</code>
...
public interface DmtReadOnlyDataPlugIn extends DmtReadOnly {
	 ...
	 * plugin. Although a read only plugin need not be concerned about
	 * transactionality, knowing the session from which it is accessed can be
	 * useful for example in the case of sending alerts.
	 * 
