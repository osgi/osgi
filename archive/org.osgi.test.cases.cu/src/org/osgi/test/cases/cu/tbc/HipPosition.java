 ...
 * @version $Revision$
 */
public class HipPosition implements ManagedControlUnit {
	
	private String id = "hip.position.id";
	private String type = "hip.position";
