...
public class TestExecPluginActivator implements BundleActivator {
	...
	public static final String ROOT = "./OSGi/test/data_plugin";
	
	public static final String INEXISTENT_NODE_VALUE = "inexistent";
	
	public static final String INEXISTENT_NODE = ROOT +"/" +INEXISTENT_NODE_VALUE ;
	
	public static final String INTERIOR_VALUE = "interior";
	
	public static final String INTERIOR_NODE = ROOT +"/" + INTERIOR_VALUE;
	...
	public static final String INEXISTENT_LEAF_VALUE = INTERIOR_VALUE + "/inexistent_leaf";
	
	public static final String INEXISTENT_LEAF_NODE = INTERIOR_NODE +"/inexistent_leaf";
	
	public static final String LEAF_VALUE = INTERIOR_VALUE + "/leaf" ;
	
	public static final String LEAF_NODE = INTERIOR_NODE + "/leaf" ;
	
	public static final String RENAMED_VALUE = "NewNode";
	
	public static final String RENAMED_NODE = ROOT + "/NewNode";
	...
	public void start(BundleContext bc) throws Exception {
		...
		String[] ifs = new String[] { DmtDataPlugin.class.getName(),DmtExecPlugin.class.getName() };
