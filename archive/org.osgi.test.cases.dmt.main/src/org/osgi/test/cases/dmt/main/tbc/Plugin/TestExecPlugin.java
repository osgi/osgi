 ...
 * 
 */
public class TestExecPlugin implements DmtDataPlugin, DmtExecPlugin {
	...
	public boolean isNodeUri(String nodeUri) {
		if (nodeUri.equals(TestExecPluginActivator.INEXISTENT_NODE)
				|| nodeUri.equals(TestExecPluginActivator.INEXISTENT_LEAF_NODE)
				|| nodeUri.equals(TestExecPluginActivator.RENAMED_NODE) ||
				nodeUri.equals(TestExecPluginActivator.INTERIOR_NODE2_COPY)) {
	...
	public String[] getChildNodeNames(String nodeUri) throws DmtException {
		if (nodeUri == TestExecPluginActivator.INTERIOR_NODE_WITH_NULL_VALUES) {
	...
	public DmtMetaNode getMetaNode(String nodeUri) throws DmtException {
		if (nodeUri.equals(TestExecPluginActivator.INTERIOR_NODE)
				|| nodeUri.equals(TestExecPluginActivator.INEXISTENT_NODE)
				|| nodeUri.equals(TestExecPluginActivator.CHILD_INTERIOR_NODE)
				|| nodeUri.equals(TestExecPluginActivator.INTERIOR_NODE2)) {
			return new TestPluginMetaNode();
		} else if (nodeUri.equals(TestExecPluginActivator.INTERIOR_NODE_COPY)
				|| nodeUri.equals(TestExecPluginActivator.INTERIOR_NODE2_COPY)) {
			return new TestPluginMetaNodeCopy();
		} else {
			return new TestPluginMetaNode(DmtData.FORMAT_INTEGER
	...
	public boolean isLeafNode(String nodeUri) throws DmtException {
		if (nodeUri.equals(TestExecPluginActivator.LEAF_NODE)) {
			return true;
		} else {
			return false;
		}
