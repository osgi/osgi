...
public class OverlappingExecPluginActivator implements BundleActivator {
	...
	public OverlappingExecPluginActivator(DmtTestControl tbc) {
		this.tbc = tbc;
	}

	public void start(BundleContext bc) throws Exception {
		// creating the service
		overlappingExecPlugin = new OverlappingExecPlugin(tbc);
		Hashtable props = new Hashtable();
		props.put("execRootURIs", new String[] { TestExecPluginActivator.TEST_EXEC_PLUGIN_ROOT });
		props.put("dataRootURIs", new String[] { TestExecPluginActivator.TEST_EXEC_PLUGIN_ROOT });
