...
public class TestExecPluginActivator implements BundleActivator {
	...
	public static final String TEST_EXEC_PLUGIN_ROOT = "./OSGi/test/exec_plugin";
	
	public static final String INTERIOR_NODE_EXCEPTION = TEST_EXEC_PLUGIN_ROOT + "/exception";
	...
	public void start(BundleContext bc) throws Exception {
		...
		props.put("execRootURIs", new String[] { TEST_EXEC_PLUGIN_ROOT });
		props.put("dataRootURIs", new String[] { TEST_EXEC_PLUGIN_ROOT });
