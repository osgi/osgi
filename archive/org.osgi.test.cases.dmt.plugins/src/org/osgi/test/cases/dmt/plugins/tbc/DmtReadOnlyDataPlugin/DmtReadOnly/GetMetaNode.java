 ...
 * @author Andre Assad
 * 
 * @methodUnderTest org.osgi.service.dmt.DmtReadOnly#getMetaNode
...
public class GetMetaNode {
	 ...
	 *                  getMetaNode to the correct plugin.
	 */
	private void testGetMetaNode001() {
		...
		try {
			...
			DmtMetaNode metanode = session.getMetaNode(TestReadOnlyDataPluginActivator.INTERIOR_NODE);
			tbc.assertTrue("Asserts that DmtAdmin fowarded "+ TestReadOnlyDataPlugin.GETMETANODE
					+" to the correct plugin", (metanode instanceof TestPluginMetaNode));
	 ...
	 *                  DmtReadOnly#getMetaNode correctly forwards the
