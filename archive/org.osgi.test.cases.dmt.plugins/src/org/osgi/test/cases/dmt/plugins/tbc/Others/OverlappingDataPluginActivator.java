...
public class OverlappingDataPluginActivator implements BundleActivator {
	...
	public OverlappingDataPluginActivator(DmtTestControl tbc) {
		this.tbc = tbc;
	}

	public void start(BundleContext bc) throws Exception {
		// creating the service
		overlappingDataPlugin = new OverlappingDataPlugin(tbc);
		Hashtable props = new Hashtable();
		props.put("dataRootURIs", new String[] { org.osgi.test.cases.dmt.plugins.tbc.DmtDataPlugin.TestDataPluginActivator.TEST_DATA_PLUGIN_ROOT });
		String[] ifs = new String[] { DmtDataPlugin.class.getName() };
		servReg = bc.registerService(ifs, overlappingDataPlugin, props);
