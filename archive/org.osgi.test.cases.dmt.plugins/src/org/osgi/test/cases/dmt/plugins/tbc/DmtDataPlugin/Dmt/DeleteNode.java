 ...
 * @author Andre Assad
 * 
 * @methodUnderTest org.osgi.service.dmt.Dmt#deleteNode
...
public class DeleteNode {
	 ...
	 *                  deleteNode to the correct plugin.
	 */
	private void testDeleteNode001() {
		...
		try {
			...
			tbc.assertEquals("Asserts that DmtAdmin fowarded "+ TestDataPlugin.DELETENODE+" to the correct plugin",TestDataPlugin.DELETENODE,DmtTestControl.TEMPORARY);
		} catch (Exception e) {
	 ...
	 *                  Dmt#deleteNode correctly forwards the 
