...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#isLeaf
 * @generalDescription This class tests DmtMetaNode.isLeaf method according with
 *                     MEG specification (rfc0085)
 */
public class IsLeaf {
	private DmtTestControl tbc;

	public IsLeaf(DmtTestControl tbc) {
		this.tbc = tbc;
	}
	...
	/**
	 * @testID testIsLeaf001
	 * @testDescription Checks whether isLeaf method returns the value defined on TestPluginMetaNode
	 */
	private void testIsLeaf001() {
		...
		tbc.assertTrue("Asserts isLeaf method", !metanode.isLeaf());
	} catch (Exception e) {
