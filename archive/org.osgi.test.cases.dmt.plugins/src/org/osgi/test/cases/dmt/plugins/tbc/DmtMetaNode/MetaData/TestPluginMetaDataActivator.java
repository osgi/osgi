...
public class TestPluginMetaDataActivator implements BundleActivator {
	...
	public static final String TEST_DATA_PLUGIN_ROOT = "./OSGi/test/metadata_plugin";
	
	public static final String INEXISTENT_NODE_STRING = "inexistent_node";
	public static final String INEXISTENT_NODE = TEST_DATA_PLUGIN_ROOT +"/" + INEXISTENT_NODE_STRING;
	
	public static final String INEXISTENT_NODE_INVALID_NAME = TEST_DATA_PLUGIN_ROOT +"/invalid_name";
	
	public static final String INTERIOR_NODE_STRING = "interior";
	public static final String INTERIOR_NODE = TEST_DATA_PLUGIN_ROOT +"/" + INTERIOR_NODE_STRING;
	...
	public void start(BundleContext bc) throws Exception {
		...
		props.put("dataRootURIs", new String[] { TEST_DATA_PLUGIN_ROOT });
