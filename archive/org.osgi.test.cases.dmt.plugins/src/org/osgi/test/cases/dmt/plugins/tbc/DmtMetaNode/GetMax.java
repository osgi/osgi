...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#getMax
 * @generalDescription This class tests DmtMetaNode.getMax method according
...
public class GetMax {
	...
	/**
	 * @testId testGetMax001
	 * @testDescprition Test whether getMax method returns the value defined on TestPluginMetaNode.
	 */
	private void testGetMax001(){
		...
		try {
			...
			tbc.assertEquals("Asserts getMax method", TestMetaNode.DEFAULT_MAX_VALUE, metanode.getMax());
		} catch (Exception e) {
