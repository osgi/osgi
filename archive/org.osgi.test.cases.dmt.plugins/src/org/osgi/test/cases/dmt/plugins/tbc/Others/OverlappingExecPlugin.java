 ...
 * (instead of that org.osgi.test.cases.dmt.tbc.DmtExecPlugin.TestExecPlugin
 * will be called)
 *  
 */
public class OverlappingExecPlugin implements DmtExecPlugin, DmtDataPlugin {

	private final String MESSAGE = "OverlappingExecPlugin";

	private DmtTestControl tbc;

	public OverlappingExecPlugin(DmtTestControl tbc) {
		this.tbc = tbc;
