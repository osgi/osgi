...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#isZeroOccurrenceAllowed
 * @generalDescription This class tests DmtMetaNode.isZeroOccurrenceAllowed
 *                     method according with MEG specification (rfc0085)
 */
public class IsZeroOccurrenceAllowed {
	...
	/**
	 * @testID testIsZeroOccurrenceAllowed001
	 * @testDescription Tests whether isZeroOccurrenceAllowed method returns the
	 *                  value defined on TestPluginMetaNode.
	 *  
	 */
