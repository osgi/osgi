...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#getPattern
 * @generalDescription This class tests DmtMetaNode.getPattern method according
 *                     with MEG specification (rfc0085)
 */
public class GetPattern {
	private DmtTestControl tbc;

	public GetPattern(DmtTestControl tbc) {
		this.tbc = tbc;
	}
	...
	/**
	 * @testID testGetPattern001
	 * @testDescription Test whether getPattern method returns the value defined
	 *                  on TestPluginMetaNode.
	 */
	private void testGetPattern001() {
		DmtSession session = null;
		try {
			tbc.log("#testGetPattern001");
