...
/**
 * @methodUnderTest org.osgi.service.dmt.DmtMetaNode#GetScope
...
public class GetScope {
	...
	/**
	 * @testID testGetScope001
	 * @testDescription Checks whether getScope method returns the value defined
	...
	private void testGetScope001() {
		...
		try {
			...
			tbc.assertEquals("Asserts getScope method", DmtMetaNode.DYNAMIC,
					metanode.getScope());
		} catch (Exception e) {
