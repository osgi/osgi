...
public class TestBad1 extends TestCaseClass {

    protected TestBad1(TestRunnerImpl tRunner) throws Exception {
        super(tRunner);
    }
    ...
    public void doTest(Db db, DeploymentAdmin da) throws Exception {
        ...
        try {
            is = new FileInputStream(tRunner.getFile("bad_db_test_01.dp"));
            try {
    ...
    public PermissionInfo[] getNeededPermissions() {
        return new PermissionInfo[] {
                new PermissionInfo(FilePermission.class.getName(), 
                        tRunner.getFile("bad_db_test_01.dp").getAbsolutePath(), "read"),
                new PermissionInfo(DeploymentAdminPermission.class.getName(), 
                        "(name=bad_db_test_01)", "install, uninstall")
            };
    }

    public String getDescription() {
        return "Missing deployment package name";
    }
