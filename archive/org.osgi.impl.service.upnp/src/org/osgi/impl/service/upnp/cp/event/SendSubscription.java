...
public class SendSubscription extends GenaSocket implements Runnable {		
	private String publisherpath;
   	...
   	public SendSubscription(String publisherpath,String hostString,String timeout, UPnPListener listener) {
	...
	// This method forms the subscription message and sends it to the given host name.
   	public void run() {
   		try {
	...
	// This method creates the subscription message based on the given details.
   	void formSubscriptionMessage() {
   		subscriptionMessage = GenaConstants.GENA_SUBSCRIBE + " "+ publisherpath.trim() + " " +
   		GenaConstants.GENA_SERVER_VERSION+"\r\n" + GenaConstants.GENA_HOST +
   		": "+ hostString + "\r\n" + GenaConstants.GENA_CALLBACK + ": "+ "<"+ 
   		GenaConstants.GENA_CALLBACK_URL+">\r\n" + GenaConstants.GENA_NT + 
   		": upnp:event\r\n" + GenaConstants.GENA_TIMEOUT + ": "+
   		timeout+"\r\n\r\n";   		
	}
