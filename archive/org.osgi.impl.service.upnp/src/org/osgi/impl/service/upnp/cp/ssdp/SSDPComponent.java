...
public class SSDPComponent implements SSDPConstants{	
	...
	// This constructor construct the SDDPcomponent. It initializez all required information for discovery layer.   
	...
	// This method starts the Discovery functionality by checking the stack type.	
	...
	public void sendMsearchRequest(){
		...
		DatagramPacket packet = new DatagramPacket(data, data.length, ssdpinet, 1900);
		for(int i = 0; i <= 1; i++){
			try{
