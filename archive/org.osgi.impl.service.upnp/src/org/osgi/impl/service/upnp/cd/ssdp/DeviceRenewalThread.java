...
public class DeviceRenewalThread extends Thread{
	...
	// This methos checks contineously check the device created time. If the created time expires
	...
	public void run(){
		while(flag){
		   try{
				...
				Thread.sleep( 5000 ); //### added so this thread does not consume all time - pkr
		   }catch(Exception e){}	
		}
	}
