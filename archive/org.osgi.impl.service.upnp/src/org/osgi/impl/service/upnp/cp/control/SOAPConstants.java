...
interface SOAPConstants {
	...
	public static final String startEnvelop = "<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelop/\" s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">";
	public static final String startBody = "<s:Body>";
	public static final String mpost = "M-POST ";
	public static final String stopEnvelop = "</s:Envelope>";
	...
	public static final String osNameVersion = System.getProperty("os.name") + "/" + System.getProperty("os.version");
