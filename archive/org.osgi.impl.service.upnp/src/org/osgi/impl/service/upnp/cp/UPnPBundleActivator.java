...
public class UPnPBundleActivator implements BundleActivator {	
	...
	// This method is called when UPnP Bundle starts,so that the Bundle can perform Bundle specific operations.
   	public void start(BundleContext bc) {		
   	 	try{
   	 		...
   	 		basedriver.start();
       		//ServiceRegistration sreg = bc.registerService("org.osgi.impl.service.upnp.cp.util.UPnPController", controller, null);
