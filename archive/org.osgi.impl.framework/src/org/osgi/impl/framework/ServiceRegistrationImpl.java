...
public class ServiceRegistrationImpl implements ServiceRegistration
{
	...
	if (reference != null) {
	    if (unregistering) {
		throw new IllegalStateException("Unregister called inside service UNREGISTER listener or inside ungetService.");
	    }
	    unregistering = true;
		...
		try {
		    ...
		    bundle.framework.listeners.frameworkEvent(new FrameworkEvent(FrameworkEvent.ERROR, bundle, pe.getException()));
