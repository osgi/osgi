 ...
 * <p>
 * Note, the behaviour is a bit different from URLStreamHandlerProxy. This is
 * because java.net.URLConnection does not cache handlers from factories and it
 * will use a simple handler that return URLConnection.getInputStream() for
 * unhandled MIME types.
 */
public class ContentHandlerProxy extends ContentHandler {
	...
	/**
	 * Renders the content for a connection. If the handler disappears, we
	 * return conn.getInputStream(). (That is what java.net.URLConnection does.)
	 */
