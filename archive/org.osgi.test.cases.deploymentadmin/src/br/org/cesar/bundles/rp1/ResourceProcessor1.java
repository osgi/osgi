 ...
 * CR            Headline
 * ============  ==============================================================
 * 25/04/2005    Andre Assad
 * 26            Implement MEG TCK for the deployment RFC-88
 * ============  ==============================================================
 */

package br.org.cesar.bundles.rp1;
 ...
 *                     installation.
 */
public class ResourceProcessor1 implements BundleActivator, ResourceProcessor {
	...
	public void start(BundleContext bc) throws Exception {
		...
		props.put("service.pid", DeploymentTestControl.PID_RESOURCE_PROCESSOR1);
		sr = bc.registerService(ResourceProcessor.class.getName(), this, props);
		System.out.println("ResourceProcessor1 started.");
