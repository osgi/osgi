...
public interface DmtExecPlugin {
     ...
     * <p>
     * The semantics of an EXEC operation and the data parameters it takes
     * depend on the definition of the managed object on which the command is
     ...
     */
    void execute(DmtSession session, String nodeUri, String correlator,
