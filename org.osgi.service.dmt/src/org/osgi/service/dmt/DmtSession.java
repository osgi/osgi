...
public interface DmtSession {
	 ...
	 *         {@code NODE_NOT_FOUND} if the node does not exist and the plugin
	 *         does not allow executing unexisting nodes <li>
	 ...
	 *         {@code DmtPermission} for the node with the Exec action present
	 * 
	 ...
	 */
	void execute(String nodeUri, String correlator, String data) throws DmtException;
	 ...
	 *         not have {@code DmtPermission} for the node with the Get action
	 *         present
	 ...
	 *         closed or invalidated
	 * @throws SecurityException in case of local sessions, if the caller does
	 *         not have {@code DmtPermission} for the node or its parent (see
	 *         above) with the Replace action present
	 */
	 ...
	 *         permissions to execute the underlying management operation, or,
	 *         in case of local sessions, if the caller does not have
	 *         {@code DmtPermission} for the copied node(s) with the Get action
	 *         present, or for the parent of the target node with the Add action
	 */
	void copy(String nodeUri, String newNodeUri, boolean recursive) throws DmtException;
	 ...
	 */
	void createLeafNode(String nodeUri, DmtData value, String mimeType) throws DmtException;
	 ...
	 *         permissions to execute the underlying management operation, or,
	 *         in case of local sessions, if the caller does not have
	 *         {@code DmtPermission} for the node with the Delete action present
	 */
	 ...
	 *         permissions to execute the underlying management operation, or,
	 *         in case of local sessions, if the caller does not have
	 *         {@code DmtPermission} for the node with the Get action present
	 */
	 ...
	 *         permissions to execute the underlying management operation, or,
	 *         in case of local sessions, if the caller does not have
	 *         {@code DmtPermission} for the node (and all its descendants in
	 *         case of interior nodes) with the Get action present
	 */
