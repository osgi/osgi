...
package org.osgi.test.cases.framework.div.tbc.FrameworkEvent;
...
/**
 * 
 * Test the constants of the class org.osgi.framework.FrameworkEvent.
 * 
 * @version $Revision$
 */
public class Constants {
	...
	public void testConstantValues0001() throws Exception {
		if (FrameworkEvent.WARNING != 0x00000010) {
			throw new ConstantsTestException("Testing constant values");
		}

		if (FrameworkEvent.INFO != 0x00000020) {
			throw new ConstantsTestException("Testing constant values");
		}
	}
}