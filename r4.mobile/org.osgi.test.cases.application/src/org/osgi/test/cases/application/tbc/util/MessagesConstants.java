...
public class MessagesConstants {
	...
	public static final String UNEXPECTED_EXCEPTION = "Unexpected exception thrown.";
	
	public static final String ASSERT_EQUALS = "Asserting if value {0} is equals to value {1}.";
