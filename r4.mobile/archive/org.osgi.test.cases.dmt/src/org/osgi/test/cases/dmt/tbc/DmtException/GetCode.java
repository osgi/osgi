...
public class GetCode {
	...
	public GetCode(DmtTestControl tbc) {
		this.tbc = tbc;
	}
	...
	public void testGetCode001() {
		org.osgi.service.dmt.DmtException de = new org.osgi.service.dmt.DmtException(
				null, org.osgi.service.dmt.DmtException.METADATA_MISMATCH, null);
		tbc.assertEquals("Asserts getCode method",org.osgi.service.dmt.DmtException.METADATA_MISMATCH,de.getCode());

		de = new org.osgi.service.dmt.DmtException(null, org.osgi.service.dmt.DmtException.METADATA_MISMATCH, null,
				new Exception());
		tbc.assertEquals("Asserts getCode method",org.osgi.service.dmt.DmtException.METADATA_MISMATCH,de.getCode());

		de = new org.osgi.service.dmt.DmtException(null, org.osgi.service.dmt.DmtException.METADATA_MISMATCH, null, new Vector());
		tbc.assertEquals("Asserts getCode method",org.osgi.service.dmt.DmtException.METADATA_MISMATCH,de.getCode());
