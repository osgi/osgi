 ...
 * @author Andre Assad
 *
 * @methodUnderTest org.osgi.service.deploymentadmin.DeploymentPackage#isStale
 * @generalDescription This Test Class Validates the implementation of
 *                     <code>isStale<code> method, according to MEG reference
...
public class IsStale {
	...
	/**
	 * @testID testIsStale001
	 * @testDescription This test case asserts that a deployment package is not
	 *                  stale after installation.
	 */
	private void testIsStale001() {
		tbc.log("#testIsStale001");
		DeploymentPackage dp = null;
		try {
			dp = tbc.installDeploymentPackage(tbc.getWebServer() + tbc.getTestingDeploymentPackage(DeploymentTestControl.SIMPLE_DP).getFilename());
