...
public interface ExportedPackage {
	 ...
	 *         not {@link BundleWiring#isInUse() in use}, {@code null} will be
	 *         returned.
	 */
	 ...
	 * the package.
	 * 
	 * @return A {@code Collection} containing a snapshot of bundle wirings
	 *         currently wired to this package, or an empty collection if no
	 *         bundles are wired to this package. If the exporter's bundle
	 *         wiring is not {@link BundleWiring#isInUse() in use}, {@code null}
	 *         will be returned.
	 */
