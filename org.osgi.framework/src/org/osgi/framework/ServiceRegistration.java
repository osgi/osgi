 ...
 * 
 * <p>
 * The Framework returns a <tt>ServiceRegistration</tt> object when a
 * <tt>BundleContext.registerService</tt> method is successful. The
...
public abstract interface ServiceRegistration {
	/**
	 * Returns a <tt>ServiceReference</tt> object for a service being
	 * registered.
	 * <p>
	 * The <tt>ServiceReference</tt> object may be shared with other bundles.
	 * 
	 * @exception java.lang.IllegalStateException If this
	 *            <tt>ServiceRegistration</tt> object has already been
	 *            unregistered.
	 ...
	 * 
	 * @exception IllegalStateException If this <tt>ServiceRegistration</tt>
	 *            object has already been unregistered.
	 * 
	 * @exception IllegalArgumentException If <tt>properties</tt> contains
	 *            case variants of the same key name.
	 */
	public abstract void setProperties(Dictionary properties);

	/**
	 * Unregisters a service. Remove a <tt>ServiceRegistration</tt> object
	 * from the Framework service registry. All <tt>ServiceReference</tt>
	 * objects associated with this <tt>ServiceRegistration</tt> object can no
	 ...
	 * it can no longer be used. <tt>ServiceReference</tt> objects for the
	 ...
	 * <tt>ServiceFactory.ungetService</tt> method is called to release the
