...
/**
 * Thrown to indicate that an operation could not complete because of
...
public class InvalidPreferencesFormatException extends Exception {
    /**
     * The line number at which a format error was detected, or -1 if
     ...
     * detail message and a line number of -1.
     *
    ...
    /**
     * Returns the line number at which a format error was detected, or
     * -1 if unknown or inapplicable.
     */
