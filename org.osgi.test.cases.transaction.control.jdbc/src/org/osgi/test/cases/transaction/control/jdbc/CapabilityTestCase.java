...
public class CapabilityTestCase extends JDBCResourceTestCase {
	...
	public void testTxControlServiceCapability() throws Exception {
		...
		List<BundleCapability> capabilities = jdbcResourceProviderBundle
		...
		for (Capability cap : capabilities) {
			...
			if (objectClass
					.contains(JDBCConnectionProviderFactory.class.getName())) {
				hasCapability = true;
