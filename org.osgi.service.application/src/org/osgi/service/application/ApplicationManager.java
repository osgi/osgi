...
public interface ApplicationManager {
	 ...
	 * 
	 * @param appUID UID of the application being locked - if UID is null,
	 *        entire device can be locked
	 * @param lockValue A boolean value true/false indicating whether the
	 *        application should be locked or not.
	 * @exception ApplicationNotFoundException Application with the specified ID
	 *            cannot be found
	 */
	 ...
	 * @param passcode Passcode (PIN) value that will enable unlocking of the
	 *        device/application
	 * @exception ApplicationNotFoundException Application with the specified ID
	 *            cannot be found
	 */
	 ...
	 * @return A boolean value true/false indicating whether the application is
	 *         locked or not.
	 * @exception ApplicationNotFoundException Application with the specified ID
	 *            cannot be found
	 */
	...
	/**
	 * This method gets the content handler service based on file extension
	 * (obtained from URL) and calls the service factory to get a ContentHandler
	 * object to be used by caller.
	 * 
	 * @param url URL of the content.
	 * @param filter A filter string (OSGi style filter string) to uniquely
	 *        identify the ContentHandlerFactory in the service registry.
