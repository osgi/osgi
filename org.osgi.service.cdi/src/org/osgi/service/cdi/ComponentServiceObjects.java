...
public interface ComponentServiceObjects<S> {
	 ...
	 * service.
	 * <p>
	 * This method will always return {@code null} when the associated service has
	 * been become unbound.
	 *
	 * @return A service object for the associated service or {@code null} if the
	 *         service is unbound, the customized service object returned by a
	...
	/**
	 * Releases a service object for the {@link #getServiceReference() associated}
	 * service.
	 * <p>
