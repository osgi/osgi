...
public enum ReferencePolicyOption {
	...
	/**
	 * Get a {@link ReferencePolicyOption ReferencePolicyOption} instance by value
	 * rather than by name.
	 *
	 * @param input a non-null value
	 * @return the {@link ReferencePolicyOption ReferencePolicyOption} matching the
	 *         value
	 * @throws NullPointerException if the input is null
	 * @throws IllegalArgumentException on invalid input
	 */
	public static ReferencePolicyOption get(String input) {
		Objects.requireNonNull(input, "input cannot be null");

		for (ReferencePolicyOption option : values()) {
			if (input.equals(option.toString()))
				return option;
		}
