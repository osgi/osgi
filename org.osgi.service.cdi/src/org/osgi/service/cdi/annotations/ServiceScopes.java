...
public enum ServiceScopes {
	 ...
	 * <p>
	 * The default behavior is {@link ServiceScopes#SINGLETON}.
	 */
	...
	/**
	 * Get a {@link ServiceScopes ServiceScope} instance by value rather than by
	 * name.
	 *
	 * @param input a non-null value
	 * @return the {@link ServiceScopes ServiceScope} matching the value
	 * @throws NullPointerException if the input is null
	 * @throws IllegalArgumentException on invalid input
	 */
	public static ServiceScopes get(String input) {
		Objects.requireNonNull(input, "input cannot be null");

		for (ServiceScopes policy : values()) {
