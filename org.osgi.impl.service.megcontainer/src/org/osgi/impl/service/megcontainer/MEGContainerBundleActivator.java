...
public class MEGContainerBundleActivator extends Object implements BundleActivator
{
  ...
  public MEGContainerBundleActivator()
  {
    super();
  }
  ...
  public void start(BundleContext bc) throws Exception
  {
    ...
    serviceReg = bc.registerService("org.osgi.service.application.ApplicationContainer", megContainerImpl, properties);
        
    Hashtable serviceListenerProps = new Hashtable();
    serviceListenerProps.put( "topic", "*" );    
    serviceListener = bc.registerService("org.osgi.service.event.ChannelListener", megContainerImpl, serviceListenerProps);    
