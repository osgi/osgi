...
public class Matcher {
	...
	public static void main(String[] args) throws Exception {
		...
		b = (-1 == find(".logg", new StringBuffer("install_log_2.log")));
		b = (0 == find("?", new StringBuffer("something")));
		b = (1 == find("o?", new StringBuffer("something")));
		b = (1 == find("o??", new StringBuffer("something")));
		b = (1 == find("o?e", new StringBuffer("something")));
		b = (5 == find("h??g", new StringBuffer("something")));
		
		b = b && Matcher.match("*567*ab*e", "3456789abcde");
		b = b && Matcher.match("*", "3456789abcde");
		b = b && Matcher.match("*", "");
		b = b && Matcher.match("", "");
		b = b && Matcher.match("*567**ab*e", "3456789abcde");
		b = b && Matcher.match("**", "3456789abcde");
		b = b && Matcher.match("**", "");
		b = b && Matcher.match("*5?7*ab*e", "3456789abcde");
		b = b && Matcher.match("*???*ab*e", "3456789abcde");
		
		b = b && !Matcher.match("*.logg", "install_log_2.log");
		b = b && !Matcher.match("", "asdsdsds");
		b = b && !Matcher.match("alma*korte", "lma*korte");
		b = b && !Matcher.match("*5?7*ab*e", "3456789abcdef");
