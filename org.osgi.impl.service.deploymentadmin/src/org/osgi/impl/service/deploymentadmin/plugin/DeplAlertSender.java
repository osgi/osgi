    ...
    private static int getResultCodeToExceptionCode(int code) {
        switch (code) {
            ...
            case DeploymentException.CODE_ORDER_ERROR :
                return PluginConstants.RESULT_DEPL_ORDER_ERROR;
            case DeploymentException.CODE_MISSING_HEADER:
                return PluginConstants.RESULT_DEPL_MISSING_HEADER;
            case DeploymentException.CODE_BAD_HEADER :
                return PluginConstants.RESULT_DEPL_BAD_HEADER;
            case DeploymentException.CODE_MISSING_FIXPACK_TARGET :
                return PluginConstants.RESULT_DEPL_MISSING_FIXPACK_TARGET;
            case DeploymentException.CODE_MISSING_BUNDLE :
                return PluginConstants.RESULT_DEPL_MISSING_BUNDLE;
            case DeploymentException.CODE_MISSING_RESOURCE :
                return PluginConstants.RESULT_DEPL_MISSING_RESOURCE;
            case DeploymentException.CODE_SIGNING_ERROR :
                return PluginConstants.RESULT_DEPL_SIGNING_ERROR;
            case DeploymentException.CODE_BUNDLE_NAME_ERROR :
                return PluginConstants.RESULT_DEPL_BUNDLE_NAME_ERROR;
            case DeploymentException.CODE_FOREIGN_CUSTOMIZER :
                return PluginConstants.RESULT_DEPL_FOREIGN_CUSTOMIZER;
            case DeploymentException.CODE_NO_SUCH_RESOURCE :
                return PluginConstants.RESULT_DEPL_NO_SUCH_RESOURCE;
            case DeploymentException.CODE_BUNDLE_SHARING_VIOLATION :
                return PluginConstants.RESULT_DEPL_BUNDLE_SHARING_VIOLATION;
            case DeploymentException.CODE_RESOURCE_SHARING_VIOLATION :
                return PluginConstants.RESULT_DEPL_CODE_RESOURCE_SHARING_VIOLATION;
            case DeploymentException.CODE_OTHER_ERROR :
                return PluginConstants.RESULT_UNDEFINED_ERROR;
            ...
            case DeploymentException.CODE_PROCESSOR_NOT_FOUND :
                return PluginConstants.RESULT_DEPL_RES_PROC_MISSING;
            default :
                return PluginConstants.RESULT_DEPL_UNDEFINED;
        }
      }
