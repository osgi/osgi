...
public interface BundleStateMBean {
	 ...
	 */
	Item			VALUE_ITEM					= new Item(VALUE, "The bundle header value", SimpleType.STRING);

	/**
	 * The Composite Type describing an entry in bundle headers. It consists of
	 * {@link #KEY_ITEM} and {@link #VALUE_ITEM}.
	 */
	CompositeType	HEADER_TYPE					= Item.compositeType("HEADER", "This type encapsulates OSGi bundle header key/value pairs", KEY_ITEM, VALUE_ITEM);
	 ...
	 * {@link #KEY_ITEM}.
	 */
	TabularType		HEADERS_TYPE				= Item.tabularType("HEADERS", "The table of bundle headers", HEADER_TYPE, KEY);
	 ...
	 */
	Item			LOCATION_ITEM				= new Item(LOCATION, "The location of the bundle", SimpleType.STRING);
	 ...
	 */
	Item			IDENTIFIER_ITEM				= new Item(IDENTIFIER, "The id of the bundle", SimpleType.LONG);
	/**
	 ...
	 */
	Item			SYMBOLIC_NAME_ITEM			= new Item(SYMBOLIC_NAME, "The symbolic name of the bundle", SimpleType.STRING);
	/**
	 ...
	 * {@link #SYMBOLIC_NAME} and the the type is {@link SimpleType#STRING}.
	 */
	Item			VERSION_ITEM				= new Item(VERSION, "The version of the bundle", SimpleType.STRING);
	/**
	 ...
	 */
	Item			START_LEVEL_ITEM			= new Item(START_LEVEL, "The start level of the bundle", SimpleType.INTEGER);
	/**
	 ...
	 * </ul>
	 */
	Item			STATE_ITEM					= new Item(STATE, "The state of the bundle", SimpleType.STRING, INSTALLED, RESOLVED, STARTING, ACTIVE, STOPPING, UNINSTALLED, UNKNOWN);
	/**
	 ...
	 */
	Item			LAST_MODIFIED_ITEM			= new Item(LAST_MODIFIED, "The last modification time of the bundle", SimpleType.LONG);

	/**
	 * The key ACTIVATION_POLICY_USED, used in
	 * {@link #ACTIVATION_POLICY_USED_ITEM}.
	 */
	 ...
	 * must be used in {@link #BUNDLE_TYPE}. The key is
	 * {@link #ACTIVATION_POLICY_USED} and the type is
	 * {@link SimpleType#BOOLEAN}.
	 */
	Item			ACTIVATION_POLICY_USED_ITEM	= new Item(ACTIVATION_POLICY_USED, "Whether the bundle activation policy must be used", SimpleType.BOOLEAN);
	 ...
	 */
	Item			PERSISTENTLY_STARTED_ITEM	= new Item(PERSISTENTLY_STARTED, "Whether the bundle is persistently started", SimpleType.BOOLEAN);
	/**
	 ...
	 * {@link SimpleType#BOOLEAN}.
	 */
	Item			REMOVAL_PENDING_ITEM		= new Item(REMOVAL_PENDING, "Whether the bundle is pending removal", SimpleType.BOOLEAN);
	/**
	 ...
	 */
	Item			REQUIRED_ITEM				= new Item(REQUIRED, "Whether the bundle is required", SimpleType.BOOLEAN);
	/**
	 ...
	 */
	Item			FRAGMENT_ITEM				= new Item(FRAGMENT, "Whether the bundle is a fragment", SimpleType.BOOLEAN);
	/**
	 ...
	 */
	Item			REGISTERED_SERVICES_ITEM	= new Item(REGISTERED_SERVICES, "The registered services of the bundle", JmxConstants.LONG_ARRAY_TYPE);
	/**
	 ...
	 * type is {@link JmxConstants#LONG_ARRAY_TYPE}.
	 */
	Item			SERVICES_IN_USE_ITEM		= new Item(SERVICES_IN_USE, "The services in use by the bundle", JmxConstants.LONG_ARRAY_TYPE);
	/**
	 ...
	 */
	Item			HEADERS_ITEM				= new Item(HEADERS, "The headers of the bundle", HEADERS_TYPE);
	 ...
	 */
	Item			EXPORTED_PACKAGES_ITEM		= new Item(EXPORTED_PACKAGES, "The exported packages of the bundle", JmxConstants.STRING_ARRAY_TYPE);
	/**
	 ...
	 * {@link JmxConstants#STRING_ARRAY_TYPE}.
	 */
	Item			IMPORTED_PACKAGES_ITEM		= new Item(IMPORTED_PACKAGES, "The imported packages of the bundle", JmxConstants.STRING_ARRAY_TYPE);
	/**
	 ...
	 */
	Item			FRAGMENTS_ITEM				= new Item(FRAGMENTS, "The fragments of which the bundle is host", JmxConstants.LONG_ARRAY_TYPE);
	/**
	 ...
	 * {@link JmxConstants#LONG_ARRAY_TYPE}
	 */
	Item			HOSTS_ITEM					= new Item(HOSTS, "The fragments of which the bundle is host", JmxConstants.LONG_ARRAY_TYPE);
	/**
	 ...
	 * {@link JmxConstants#LONG_ARRAY_TYPE}
	 */
	Item			REQUIRED_BUNDLES_ITEM		= new Item(REQUIRED_BUNDLES, "The required bundles the bundle", JmxConstants.LONG_ARRAY_TYPE);
	/**
	 ...
	 */
	Item			REQUIRING_BUNDLES_ITEM		= new Item(REQUIRING_BUNDLES, "The bundles requiring the bundle", JmxConstants.LONG_ARRAY_TYPE);
	 ...
	 */
	Item			EVENT_ITEM					= new Item(EVENT, "The type of the event: {INSTALLED=1, STARTED=2, STOPPED=4, UPDATED=8, UNINSTALLED=16}", SimpleType.INTEGER);
	 ...
	 * </ul>
	 */
	CompositeType	BUNDLE_EVENT_TYPE			= Item.compositeType("BUNDLE_EVENT", "This type encapsulates OSGi bundle events", IDENTIFIER_ITEM, LOCATION_ITEM, SYMBOLIC_NAME_ITEM, EVENT_ITEM);
	 ...
	 */
	TabularType		BUNDLES_TYPE				= Item.tabularType("BUNDLES", "A list of bundles", BUNDLE_TYPE, IDENTIFIER);
	 ...
	 * result. Note that the {@link #IDENTIFIER} item is always returns as this
	 * the key in the {@code TabularData} structure.
	 * 
	 * @param items The names of the items to include in the result.
	 * @return the tabular representation of the bundle state
	 * @throws IOException if the operation fails
	 */
	 ...
	 * 
	 * @param bundleId the identifier of the bundle
	 * @return true if the bundle's autostart setting indicates the activation
