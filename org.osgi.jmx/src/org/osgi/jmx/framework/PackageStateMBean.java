...
public interface PackageStateMBean {
	 ...
	 * TODO packageName and version is not unique
	 */
	 ...
	 * 
	 * TODO Is ExportingBundle not a better name?
	 */
	 ...
	 */
	String			IS_REMOVAL_PENDING			= "PendingRemoval";
	/**
	 * 
	 */
	Item			IS_REMOVAL_PENDING_ITEM	= new Item(
													IS_REMOVAL_PENDING,
	 ...
	 * <li>{@link #IS_REMOVAL_PENDING_ITEM}</li>
	...
	CompositeType	PACKAGE_TYPE			= Item
													.compositeType(
															...
															NAME_ITEM,
															IS_REMOVAL_PENDING_ITEM,
															VERSION_ITEM
															);

	/**
	 * The Tabular Type used in {@link #listPackages()}.
	 */
