...
public interface BundleWiringStateMBean {
     ...
     * Used in {@link #DIRECTIVE_TYPE}.
     * The key is {@link #KEY} and the type is a String.
     */
     ...
     * Used in {@link #DIRECTIVE_TYPE}.
     * They key is {@link #VALUE} and the type is a String.
     */
    ...
    /**
     * The Tabular Type that holds the directives for a capability or requirement. The row
     * type is {@link #DIRECTIVE_TYPE} and the index is {@link #KEY}.
     */
    ...
    /**
     * The item containing the directives of a capability or requirement. Used in
     * {@link #BUNDLE_REQUIREMENT_TYPE} and {@link #BUNDLE_CAPABILITY_TYPE}.
    ...
    /**
     * The Tabular Type that holds the attributes for a capability or requirements. The row
     * type is {@link JmxConstants#PROPERTY_TYPE} and the index is {@link JmxConstants#KEY}.
     */
    ...
    /**
     * The item containing the attributes of a capability or requirement. Used in
     * {@link #BUNDLE_REQUIREMENT_TYPE} and {@link #BUNDLE_CAPABILITY_TYPE}.
    ...
    /**
     * The item containing the namespace for a capability or requirement. Used in
     * {@link #BUNDLE_REQUIREMENT_TYPE} and {@link #BUNDLE_CAPABILITY_TYPE}.
    ...
    CompositeType BUNDLE_REQUIREMENT_TYPE =
        Item.compositeType("BUNDLE_REQUIREMENT",
                "Describes the requirement of a bundle",
    ...
    CompositeType BUNDLE_CAPABILITY_TYPE =
        Item.compositeType("BUNDLE_CAPABILITY",
                "Describes the capability of a bundle",
                ATTRIBUTES_ITEM, DIRECTIVES_ITEM, NAMESPACE_ITEM);
    ...
    /**
     * The item containing a requirement for a bundle in {@link #BUNDLE_WIRE_TYPE}.
     * The key is {@link #BUNDLE_REQUIREMENT} and the type is {@link #BUNDLE_REQUIREMENT_TYPE}.
     */
    ...
    /**
     * The item containing a capability for a bundle in {@link #BUNDLE_WIRE_TYPE}.
     * The key is {@link #BUNDLE_CAPABILITY} and the type is {@link #BUNDLE_CAPABILITY_TYPE}.
     */
    ...
    /**
     * The local ID of a provider revision in {@link #BUNDLE_WIRE_TYPE}.
     * This ID is local to the result where it resides and has no defined meaning across
     * multiple invocations.
     * The key is {@link #PROVIDER_BUNDLE_REVISION_ID} and the type is an int.
     */
    ...
    /**
     * The local ID of a requirer revision in {@link #BUNDLE_WIRE_TYPE}.
     * This ID is local to the result where it resides and has no defined meaning across
     * multiple invocations.
     * The key is {@link #REQUIRER_BUNDLE_REVISION_ID} and the type is an int.
     */
    ...
    /**
     * The Composite type that represents a bundle wire describing the live association between a provider of a capability
     * and a requirer of the corresponding requirement. <p/>
     * The composite consists of:
     * <ul>
    ...
    /**
     * The item containing a bundle revision ID. A bundle revision ID is always local to the result
     * of a JMX invocation and do not have a defined meaning across invocation calls. They are used
     * where a result can potentially contain multiple revisions of the same bundle.
     * The key is {@link #BUNDLE_REVISION_ID} and the type is an integer.
     */
     ...
     * They key is {@link #BUNDLE_ID} and the type is a long.
     */
    ...
    /**
     * The item containing the requirements in {@link #REVISION_REQUIREMENTS_TYPE}
     * and {@link #BUNDLE_WIRING_TYPE}.
     * The key is {@link #REQUIREMENTS} and the type is {@link #REQUIREMENT_TYPE_ARRAY}.
     */
     ...
     * is {@link #REVISION_REQUIREMENTS_TYPE} and the index is {@link #BUNDLE_REVISION_ID}.
     */
    ...
    /**
     * The item containing the capabilities in {@link #REVISION_CAPABILITIES_TYPE}
     * and {@link #BUNDLE_WIRING_TYPE}.
     * The key is {@link #CAPABILITIES} and the type is {@link #CAPABILITY_TYPE_ARRAY}.
     */
     ...
     * is {@link #REVISION_CAPABILITIES_TYPE} and the index is {@link #BUNDLE_REVISION_ID}.
     */
