...
public class OSGiBundle {
	...
	public CompositeData asCompositeData() {
		...
		itemValues[3] = version;
		itemValues[4] = startLevel;
		itemValues[5] = state;
		itemValues[6] = lastModified;
		itemValues[7] = persistentlyStarted;
		itemValues[8] = removalPending;
		itemValues[9] = required;
		itemValues[10] = fragment;
		itemValues[11] = LongArrayFrom(registeredServices);
		itemValues[12] = LongArrayFrom(servicesInUse);
		itemValues[13] = headerTable(headers);
		itemValues[14] = exportedPackages;
		itemValues[15] = importedPackages;
		itemValues[16] = LongArrayFrom(fragments);
		itemValues[17] = LongArrayFrom(hosts);
		itemValues[18] = LongArrayFrom(requiredBundles);
		itemValues[19] = LongArrayFrom(requiringBundles);
