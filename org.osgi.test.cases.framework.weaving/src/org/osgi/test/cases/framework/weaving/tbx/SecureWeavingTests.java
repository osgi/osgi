...
/**
 * This class tests that Classes cannot be woven without the relevant permissions
 * 
 * @author IBM
 */
public class SecureWeavingTests extends DefaultTestBundleControl implements WeavingHook{
