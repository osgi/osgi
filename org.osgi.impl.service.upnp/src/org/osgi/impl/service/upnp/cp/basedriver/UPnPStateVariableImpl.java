...
public class UPnPStateVariableImpl implements SamsungUPnPStateVariable{
    ...
    public Class getJavaDataType(){
    	if((type.equals("ui1")) || (type.equals("ui2")) || (type.equals("i1")) || (type.equals("i2")) || (type.equals("i4")) || (type.equals("int")) ){
    		Integer in = new Integer("1");
    		return in.getClass();
    	}else if(type.equals("ui2")){
    		Long ll = new Long("1");
    		return ll.getClass();
    	}else if((type.equals("r4")) || (type.equals("float"))){
    		Float ff = new Float("1");
    		return ff.getClass();
    	}else if((type.equals("r8")) || (type.equals("number")) || (type.equals("fixed.14.4"))){
    		Double dd = new Double("1");
    		return dd.getClass();
    	}else if((type.equals("string")) || (type.equals("uri")) || (type.equals("uuid"))){
	...
	// This method returns the value of the state variable's sendEvent attribute.
