...
public class Element {
	...
	// This constructor creates the Element object using the name and the value of the element.
	...
	// This constructor creates the Element object using the name of the element.
	Element(String nam)   {
		this();
		this.name = nam;
	}

	// This method sets the value for the element. And this method is called when the comment is
	...
	// This method returns the count of the number of child elements to the current element.
