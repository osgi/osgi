...
public class UnsubscribeCheck extends ErrorCheck {
	...
	// This method will be called by processor for processing unsubscription request.Checks for the
	// valid headers and if valid, removes the entry from eventregistry.Notifies event registry to
	// check whether the eventlistener associated with this subscription can be unregistred from the
	// framework or not.
	...
	// writes the data back to the client. It can be an error message or a valid unsubscription
	// response message.
