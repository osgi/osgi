...
public class RenewalCheck extends ErrorCheck {
	...
	// This method does all the renewal processing. Checks for valid headers and if valid
	...
	public void renew () {
		...
		String sid = (String)headers.get("sid");
   		Subscription subscription = (Subscription)EventRegistry.getSubscriber(sid);	
