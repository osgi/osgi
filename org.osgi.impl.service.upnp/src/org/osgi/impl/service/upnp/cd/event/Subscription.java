...
public class Subscription 
{
   ...
   public Subscription(String subscriptionId, String publisherpath, long t, String time, 
   String host, String callback) {
	...
	// Returns true if this subsctiption object is a valid one else returns false.
	boolean getActive() {
		return active ;
	}
	...
	// This function sets the event key with an increment of 1. If reached the max . value , ie
