...
/**
 * @methodUnderTest org.osgi.util.mobile.TransferCostCondition#getInstance
...
public class GetInstance {
	...
	public void testGetInstance001() {
		...
		try {
			Condition cond = TransferCostCondition.getInstance(
	...
	public void testGetInstance002() {
		...
		try {
			Condition cond = TransferCostCondition
					.getInstance(PolicyTestControl.TEST_BUNDLE,
	...
	public void testGetInstance003() {
		...
		try {
			Condition cond = TransferCostCondition.getInstance(
					PolicyTestControl.TEST_BUNDLE, TransferCostCondition.HIGH);
	...
	public void testGetInstance004() {
        ...
        try {
			Condition cond = TransferCostCondition.getInstance(
					...
					PolicyTestControl.INVALID_COST_LIMIT);
