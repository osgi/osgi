...
public class TransferCostConditionConstants {
	...
	public TransferCostConditionConstants(PolicyTestControl tbc) {
		this.tbc = tbc;
	}
	...
	public void testConstants() {
		tbc.assertEquals(MessagesConstants.getMessage(
				MessagesConstants.ASSERT_EQUALS, new String[] { "LOW",
						TransferCostCondition.LOW }), "LOW",
				TransferCostCondition.LOW);

		tbc.assertEquals(MessagesConstants.getMessage(
				MessagesConstants.ASSERT_EQUALS, new String[] { "MEDIUM",
						TransferCostCondition.MEDIUM }), "MEDIUM",
				TransferCostCondition.MEDIUM);

		tbc.assertEquals(MessagesConstants.getMessage(
				MessagesConstants.ASSERT_EQUALS, new String[] { "HIGH",
						TransferCostCondition.HIGH }), "HIGH",
