...
/**
 * @methodUnderTest org.osgi.util.gsm.IMSICondition#getInstance
...
public class GetInstance {
	...
	public void testGetInstance002() {
        ...
        try {
			Condition cond = IMSICondition.getInstance(null,
					PolicyTestControl.IMSI_VALID_CODE);
	...
	public void testGetInstance005() {
		...
		try {
			Condition cond = IMSICondition.getInstance(
					PolicyTestControl.TEST_BUNDLE,
					PolicyTestControl.IMSI_MORE_DIGIT_CODE);
	...
	public void testGetInstance006() {
		...
		try {
			Condition cond = IMSICondition.getInstance(PolicyTestControl.TEST_BUNDLE,
	...
	public void testGetInstance007() {
		...
		try {
			Condition cond = IMSICondition.getInstance(
					PolicyTestControl.TEST_BUNDLE,
					PolicyTestControl.IMSI_LESS_DIGIT_CODE);
