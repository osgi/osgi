...
/**
 * This dictionary holds the properties of a configuration.
 * A separate class was necessary to provide simultaneously 
 * case insensitivity of lookup and preservation of case of keys.
 *
...
public class CMDictionary   
  ...
  public Object get(Object key) {
    ...
    Object realCase = 
      lowerToRealCase.get(((String) key).toLowerCase());
    if (realCase != null)   {
  ...
  /**
   * Puts the key-value pair in the hashtable. If the hashtable
   * already contains this key or one that is equal-ignore-case to 
   * the new key, the old key-value pair is removed from hashtable.
   * 
   * @param   key  the hashtable key
   * @param   value  the value
   * @return     the previous value corresponding to this key 
   *             or to any key which is equal-ignore-case to the new key.
   */
  public Object put(Object key, Object value) {
    ...
    if (oldValue == null && lowerToRealCase != null) {
      Object oldKey = 
        lowerToRealCase.put(((String) key).toLowerCase(), key);
  ...
  /**
   * If the hashtable contains a key, which is equal-ignore-case
   * to the one passed, the key-value pair is removed from the hashtable
  ...
  /**
   * Copies the properties into the hashtable.
   * If new properties' keys match those in the hashtable,
   * the new key-value pairs overwrite old ones.
   *
