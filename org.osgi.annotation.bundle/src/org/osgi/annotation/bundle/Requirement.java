 ...
 *              name="osgi.component", filter="(version>=1.3.0)")
 * </pre>
 * <p>
...
public @interface Requirement {
	 ...
	 * specified {@link #filter()}, to the requirement's filter to test that an
	 * attribute with the name of the namespace is equal to the value of the
	 * specified name.
	 */
	String name() default "";
