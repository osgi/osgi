...
public class BundleWiringStateMBeanTestCase extends MBeanGeneralTestCase {
    ...
    public void testGetRevisionsDeclaredRequirements() throws Exception {
        ...
        for (List<?> key : (Set<List<?>>) revReqs.keySet()) {
            ...
            for (CompositeData req : (CompositeData []) data.get(BundleWiringStateMBean.REQUIREMENTS)) {
                ...
                } else if (filter.matches(".*" + BundleRevision.PACKAGE_NAMESPACE + "[ ]*=[ ]*org[.]osgi[.]test[.]cases[.]jmx[.]tb2[.]api.*")) {
    ...
    public void testGetRevisionsDeclaredCapabilities() throws Exception {
        ...
        for (List<?> key : (Set<List<?>>) revCaps.keySet()) {
            ...
            assertEquals("org.osgi.test.cases.jmx.tb2.api", attrs.get(new Object [] {BundleRevision.PACKAGE_NAMESPACE}).get("Value"));
        ...
        for (List<?> key : (Set<List<?>>) revCaps.keySet()) {
            ...
            for (CompositeData cap : caps) {
                ...
                if (BundleRevision.PACKAGE_NAMESPACE.equals(namespace)) {
                    ...
                    assertTrue("Symbolic name should either be 'org.osgi.test.cases.jmx.tb2' or 'org.osgi.test.cases.jmx.tb2_updated'",
                        ((String) attrs.get(new Object [] {BundleRevision.BUNDLE_NAMESPACE}).get("Value")).startsWith("org.osgi.test.cases.jmx.tb2"));
                    ...
                    assertTrue("Symbolic name should either be 'org.osgi.test.cases.jmx.tb2' or 'org.osgi.test.cases.jmx.tb2_updated'",
                        ((String) attrs.get(new Object [] {BundleRevision.HOST_NAMESPACE}).get("Value")).startsWith("org.osgi.test.cases.jmx.tb2"));
                    ...
                    assertTrue("Symbolic name should either be 'org.osgi.test.cases.jmx.tb2' or 'org.osgi.test.cases.jmx.tb2_updated'",
                        ((String) attrs.get(new Object [] {"osgi.identity"}).get("Value")).startsWith("org.osgi.test.cases.jmx.tb2"));
        ...
        try {
            ...
            for (List<?> key : (Set<List<?>>) closure.keySet()) {
                if (key.get(0).equals(testBundle4.getBundleId())) {
                    ...
                    String ipTb2Pattern = ".*" + BundleRevision.PACKAGE_NAMESPACE + "[ ]*=[ ]*org[.]osgi[.]test[.]cases[.]jmx[.]tb2[.]api.*";
                    ...
                    for (CompositeData wire : (CompositeData []) b4Wiring.get(BundleWiringStateMBean.REQUIRED_WIRES)) {
                        ...
                        if (BundleRevision.PACKAGE_NAMESPACE.equals(capability.get(BundleWiringStateMBean.NAMESPACE))) {
                            ...
                            } else if ("org.osgi.test.cases.jmx.tb2.api".equals(pkg)) {
            ...
            for (List<?> key : (Set<List<?>>) closure.keySet()) {
                if (key.get(0).equals(testBundle2.getBundleId())) {
                    ...
                    if (isUpdated) {
                        ...
                        assertEquals("org.osgi.test.cases.jmx.tb2_updated", attrs.get(new Object [] {Constants.BUNDLE_SYMBOLICNAME_ATTRIBUTE}).get("Value"));
                        assertEquals(testBundle2.getVersion(), new Version((String) attrs.get(new Object [] {Constants.BUNDLE_VERSION_ATTRIBUTE}).get("Value")));
                        ...
                        String filter = (String) dirs.get(new Object [] {"filter"}).get("Value");
                        assertTrue(filter.matches(".*" + BundleRevision.PACKAGE_NAMESPACE + "[ ]*=[ ]*org[.]osgi[.]test[.]cases[.]jmx[.]tb2[.]api.*"));
                        ...
                        assertEquals("org.osgi.test.cases.jmx.tb2", attrs.get(new Object [] {Constants.BUNDLE_SYMBOLICNAME_ATTRIBUTE}).get("Value"));
                        assertEquals(testBundle2.getVersion(), new Version((String) attrs.get(new Object [] {Constants.BUNDLE_VERSION_ATTRIBUTE}).get("Value")));
