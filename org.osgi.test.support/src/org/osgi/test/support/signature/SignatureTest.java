 ...
 */
public abstract class SignatureTest extends TestCase implements ParserCallback {
	Class clazz;
	Method methods[];
	...
	public void doPackage(Bundle bundle, String path) throws IOException {
		found = new HashSet();
		missing = new HashSet();
		Enumeration e = bundle.findEntries(path, null, true);
		if (e == null)
			fail("No Signature Files found in OSGI-INF/signature");
	...
	public void testSignature() throws IOException {
		doPackage(context.getBundle(), "OSGI-INF/signature");
	}
}