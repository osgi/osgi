...
import org.osgi.impl.service.dmt.dispatcher.old.PluginDispatcher;
...
public class RootPlugin implements DataPlugin, ReadableDataSession {
    ...
    public RootPlugin(PluginDispatcher dispatcher) {
        this.dispatcher = dispatcher;
    }
    
    // precondition: path must be absolute
    public static boolean isValidDataPluginRoot(String[] path) {
