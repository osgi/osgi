...
public class PluginDispatcher extends ServiceTracker implements Dispatcher {
	...
	public PluginDispatcher(BundleContext context, Filter filter) {
	...
	public org.osgi.impl.service.dmt.dispatcher.Plugin getDataPlugin(Node node) {
