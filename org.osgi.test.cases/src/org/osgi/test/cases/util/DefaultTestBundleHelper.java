...
public abstract class DefaultTestBundleHelper extends Logger implements
		Runnable, BundleActivator {
	...
	public void start(BundleContext context) {
		try {
			...
			testLoggerRef = context.getServiceReference(TestLogger.class
					.getName());
