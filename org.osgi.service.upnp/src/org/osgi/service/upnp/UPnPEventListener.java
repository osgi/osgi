 ...
 * an object of type <tt>org.osgi.framework.Filter</tt>.
 * <p>
 * When the Filter is evaluated, the folowing keywords are recognized as defined
 * as literal constants in the <tt>UPnPDevice</tt> class.
 * <p>
 * The valid subset of properties for the registration of UPnP Event Listener
 * services are:
 * <ul>
 * <li><tt>UPnPDevice.TYPE</tt>-- Which type of device to listen for events.
 * </li>
 * <li><tt>UPnPDevice.ID</tt>-- The ID of a specific device to listen for
 * events.</li>
 * <li><tt>UPnPService.TYPE</tt>-- The type of a specific service to listen
 * for events.</li>
 * <li><tt>UPnPService.ID</tt>-- The ID of a specific service to listen for
 * events.</li>
 * </ul>
 */
public interface UPnPEventListener {
	 ...
	 * <tt>org.osgi.framework.Filter</tt> and that is used to limit received
	 * events.
	 */
	 ...
	 * 
	 * The events are collected in a <tt>Dictionary</tt> object. Each entry
	 * has a <tt>String</tt> key representing the event name (= state variable
	 ...
	 * @param events <tt>Dictionary</tt> object containing the new values for
