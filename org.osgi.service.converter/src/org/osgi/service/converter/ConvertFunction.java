...
public interface ConvertFunction<F, T> {
	 ...
	 * @return The conversion result. A {@link ConvertResult} may indicate that
	 *         conversion was not successful. In this case the next matching
	 *         rule or adapter will be given a opportunity to convert.
	 */
