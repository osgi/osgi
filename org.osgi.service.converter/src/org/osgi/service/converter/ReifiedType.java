 ...
 * without relying on the Java 5 (and later) Type classes.
 * 
 ...
 *   }
 * </pre>
 * The Type graph for map will be quite complex due to the variable {@code T} 
 * 
 * @param <T> The raw type.
 * @Immutable
 * @version $Id$
 */
public class ReifiedType<T> {
	private final static ReifiedType<Object>	OBJECT	= new ReifiedType<Object>(
																Object.class);
