					...
					if (c == '\\') {
						...
						if (c == '=') {
							...
							if (c == ')') {
								...
								if (c == '(') {
									// An ugly hack, haven't got time to clean
									// this up atm
									sb.append(c);
							...
							if (obj instanceof Short) {
								...
								if (obj instanceof Byte) {
									...
									if (obj instanceof Double) {
										return compareSign(op, Double
												.valueOf(s).compareTo(obj));
									}
									else
										if (obj instanceof Float) {
											return compareSign(op, Float
													.valueOf(s).compareTo(obj));
										}
										else
												...
												if (obj instanceof Comparable) {
													Constructor c = obj
															...
															.getConstructor(
																	new Class[] {s
																			.getClass()});
													Comparable cobj = (Comparable) c
															.newInstance(new Object[] {s});
													return compareSign(op, cobj
															.compareTo(obj));
												}
												else
													if (obj instanceof Vector) {
														for (Enumeration e = ((Vector) obj)
																.elements(); e
																.hasMoreElements();)
															if (compare(
																	e
