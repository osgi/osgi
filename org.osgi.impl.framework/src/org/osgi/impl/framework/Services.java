...
public class Services
{
	...
	synchronized (this) {
		...
		if (classes[i].equals(PackageAdmin.class.getName()) &&
		    ...
		    throw new IllegalArgumentException("Illegal to register PackageAdmin service");
		}
		if (classes[i].equals(PermissionAdmin.class.getName()) &&
		    bundle.getBundleId() != 0) {
		    throw new IllegalArgumentException("Illegal to register PermissionAdmin service");
		}
		if (classes[i].equals(StartLevel.class.getName()) &&
		    bundle.getBundleId() != 0) {
		    throw new IllegalArgumentException("Illegal to register StartLevel service");
		}
