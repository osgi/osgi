...
public class BundleContextImpl implements BundleContext {
	...
	public ServiceRegistration registerService(String[] clazzes,
		...
		return framework.services
				.register(bundle, classes, service, properties);
	}
	...
	public ServiceReference[] getServiceReferences(String clazz, String filter)
		...
		if (framework.checkPermissions) {
			try {
				...
				AccessController.checkPermission(new ServicePermission(c,
	...
	/**
	 * Creates a File object for a file in the persistent storage area provided
	 * for the bundle.
	 * 
	...
	/**
	 * Constructs a Filter object. This filter object may be used to match a
	 * {@link ServiceReference}or a Dictionary.
	 * 
