 ...
 */
public final class MultiLevelControlTest extends AbstractDeviceTest {
	...
	public void testSetData() throws IllegalStateException, DeviceException {
		DeviceFunction[] multiLevelControls = null;
		try {
			multiLevelControls = super.getDeviceFunctions(MultiLevelControl.class.getName(), null, null);
	...
	private LevelData[] getMultiLevelTestData(PropertyMetadata propertyMetadata) {
		...
		DeviceFunctionData[] testData = propertyMetadata.getEnumValues(null);
		if (null != testData) {
		...
		DeviceFunctionData minData = propertyMetadata.getMinValue(null);
		DeviceFunctionData maxData = propertyMetadata.getMaxValue(null);
		if (null == minData) {
