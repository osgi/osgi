 ...
 */
public final class MultiLevelSensorTest extends AbstractDeviceTest {
	...
	public void testGetData() throws IllegalStateException, DeviceException {
		DeviceFunction[] multiLevelSensors = null;
		try {
			multiLevelSensors = super.getDeviceFunctions(MultiLevelSensor.class.getName(), null, null);
