...
public final class DTOConstants {
	 ...
	 * {@link JakartarsWhiteboardConstants#JAKARTA_RS_EXTENSION_SELECT} property
	 * and one or more of the filters is not matched.
	 */
	public static final int	FAILURE_REASON_REQUIRED_EXTENSIONS_UNAVAILABLE	= 5;

	/**
	 * The service is registered in the service registry with the
	 * {@link JakartarsWhiteboardConstants#JAKARTA_RS_NAME} property and a
	 * service with that name already exists in the runtime
	 */
	public static final int	FAILURE_REASON_DUPLICATE_NAME					= 6;

	/**
	 * The service is registered in the service registry with the
	 * {@link JakartarsWhiteboardConstants#JAKARTA_RS_APPLICATION_SELECT}
	 * property and the filters is not matched by any running application.
	 */
