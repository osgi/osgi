 ...
 * resource to declare require that JSON support is available before the
 * resource becomes active. It also adds an optional {@link Requirement} for a
 * service providing this media type to aid with provisioning.
 * 
...
public @interface JSONRequired {
	/**
	 * A filter requiring an <code>osgi.jakartars.media.type</code> of
	 * <code>application/json</code>
	 */
	public static final String FILTER = "(osgi.jakartars.media.type="
			+ APPLICATION_JSON + ")";
	 ...
	 * JSON media type
	 * 
	 * @return A filter requiring an <code>osgi.jakartars.media.type</code> of
	 *         <code>application/json</code>
	 */
	String osgi_jakartars_extension_select() default FILTER;
}
