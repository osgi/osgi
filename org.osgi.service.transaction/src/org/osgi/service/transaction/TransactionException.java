...
public class TransactionException extends Exception {
	...
	private TransactionException(String message, int errorCode) {
		super(message != null ? message : getString(errorCode));
		this.errorCode = errorCode;
	}

	/**
	 * Creates new transaction exception, with specified error message and
	 * nested cause
	 * 
	 * @param message description of the error
	...
	public TransactionException(String message, Throwable cause) {
		this(message, cause, UNDEFINED);
	}

	/**
	 * Creates new transaction exception, with specified error message and
	 * nested cause. Also assigns an error code.
	 * 
	 * @param message description of the error
	 * @param cause the nested cause
	 * @param errorCode the error code
	 */
	public TransactionException(String message, Throwable cause, int errorCode) {
		super(message != null ? message : getString(errorCode), cause);
		this.errorCode = errorCode;
	}
