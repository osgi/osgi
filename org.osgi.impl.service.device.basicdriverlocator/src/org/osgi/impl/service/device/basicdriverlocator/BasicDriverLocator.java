 ...
 *
 * Uses a text-based driver database in Properties format. The driver
 * is named <code>driverDB.props</code> and should reside in the 
 * bundle jar file.
 *
 * <p> 
...
public class BasicDriverLocator implements DriverLocator {
  ...
  Hashtable loadDriverDB() {
	...
	System.getProperty("org.osgi.service.basicdriverlocator.dburl");
      ...
      // If property exists, try to open URL, otherwise use internal props.
