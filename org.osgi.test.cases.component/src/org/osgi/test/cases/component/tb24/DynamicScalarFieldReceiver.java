...
public class DynamicScalarFieldReceiver implements ScalarFieldTestService<BaseService> {
	private volatile BaseService									service;
	private volatile Object											assignable;
	private volatile ServiceReference<BaseService>					reference;
	private volatile ComponentServiceObjects<BaseService>			serviceobjects;
