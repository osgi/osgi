 ...
 * ===========  ==============================================================
 */
package org.osgi.test.cases.application.tbc.ApplicationDescriptor;
 ...
 */
public class ApplicationDescriptorConstants {
	...
	public void testConstants001() {
		...
		tbc.assertEquals("Asserting APPLICATION_AUTOSTART value", "application.autostart", org.osgi.service.application.ApplicationDescriptor.APPLICATION_AUTOSTART);
		...
		tbc.assertEquals("Asserting APPLICATION_SINGLETON value", "application.singleton", org.osgi.service.application.ApplicationDescriptor.APPLICATION_SINGLETON);
		tbc.assertEquals("Asserting APPLICATION_VENDOR value", "application.vendor", org.osgi.service.application.ApplicationDescriptor.APPLICATION_VENDOR);
