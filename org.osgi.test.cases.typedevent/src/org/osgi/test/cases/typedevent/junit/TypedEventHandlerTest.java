...
import org.osgi.test.cases.typedevent.dto.TestEvent;
import org.osgi.test.cases.typedevent.handler.TestEventHandler;
...
public class TypedEventHandlerTest {
	...
	@Test
	public void basicTest(@InjectBundleContext
	BundleContext bc) {
