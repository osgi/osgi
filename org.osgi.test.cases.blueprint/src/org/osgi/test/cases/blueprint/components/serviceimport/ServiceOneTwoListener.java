 ...
 */
public class ServiceOneTwoListener extends ServiceListener {

    public ServiceOneTwoListener(String componentId) {
        super(componentId);
    }
    ...
    public void unbind(TestServiceTwo service, Map serviceProperties) {
        unbind(TestServiceTwo.class, serviceProperties);
    }
}
