 ...
 */
public class NamespaceChecker extends BaseTestComponent {
    public NamespaceChecker(String componentId) {
        super(componentId);
    }
    ...
    public void setBundle(Bundle bundle) {
        AssertionService.assertNotNull(this, "Null bundle value injected", bundle);
     ...
     * @param format The injected format object.
     */
    public void setAltBundle(Bundle bundle) {
        AssertionService.assertNotNull(this, "Null bundle value injected", bundle);
        AssertionService.sendEvent(this, AssertionService.METHOD_CALLED);
    }
}
