 ...
 * the expected.
 */
public class ArgumentMetadataValidator extends MetadataValidator {
     ...
     */
    public ArgumentMetadataValidator(String componentId) {
     ...
     */
    public ArgumentMetadataValidator(String componentId, TestArgument[] parms) {
        super();
     ...
     */
    public ArgumentMetadataValidator(String componentId, TestArgument parm) {
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        blueprintMetadata.validateArgumentMetadata(componentId, parms);
    }
}
