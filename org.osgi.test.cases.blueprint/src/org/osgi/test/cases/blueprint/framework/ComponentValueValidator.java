...
/**
 * Validate a component instance when the target component
 * is not one of our test components.  Used for validating
 * different factory-produced values.
 */
public class ComponentValueValidator extends MetadataValidator {
    // the external component id
    protected String componentId;
    // the expected component value (must compare equals)
    protected Object value;

    public ComponentValueValidator(String componentId, Object value) {
        super();
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        // the expected and received values must be equal.
        assertEquals("Invalid component value", value, blueprintMetadata.getComponent(componentId));
    }
}
