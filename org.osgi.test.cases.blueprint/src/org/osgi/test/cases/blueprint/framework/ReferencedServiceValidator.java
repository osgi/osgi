...
public class ReferencedServiceValidator extends MetadataValidator {
     ...
     */
    public ReferencedServiceValidator(ReferencedService[] services) {
        super();
     ...
     */
    public ReferencedServiceValidator(ReferencedService expectedService) {
        super();
        this.referencedServices = new ReferencedService[] { expectedService };
    }
