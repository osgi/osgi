...
/**
 * A class to register a BlueprintListener replay
 * listener at various test cycles.
 */
public class ReplayListenerRegister implements TestCleanup, TestEventListener, TestInitializer {
    // The ReplayListener instance we're interfacing with
    protected ReplayListener listener;

    public ReplayListenerRegister(ReplayListener listener) {
