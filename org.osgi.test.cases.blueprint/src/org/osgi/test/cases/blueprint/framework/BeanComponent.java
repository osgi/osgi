...
public class BeanComponent extends Assert implements TestComponentMetadata {
    ...
    public BeanComponent(String name, Class classType, String factoryMethodName, String initMethodName, String destroyMethodName, TestArgument[] parms, TestProperty[] props, String[] dependsOn, boolean isLazy, String scope) {
        this.name = name;
        if (classType != null) {
    ...
    public void validate(BlueprintMetadata blueprintMetadata, ComponentMetadata componentMeta) throws Exception {
        ...
        assertEquals("Component lazy attribute", isLazy, meta.isLazyInit());
