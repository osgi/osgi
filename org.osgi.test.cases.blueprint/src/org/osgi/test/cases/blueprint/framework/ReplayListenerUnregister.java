...
/**
 * A class to unregister a BlueprintListener replay
 * listener at various test cycles.
 */
public class ReplayListenerUnregister implements TestCleanup, TestEventListener, TestInitializer {
    // The ReplayListener instance we're interfacing with
    protected ReplayListener listener;

    public ReplayListenerUnregister(ReplayListener listener) {
