...
/**
 * Generic validate for the different ComponentMetadata types
 */
public class ComponentMetadataValidator extends MetadataValidator {
    // the expected set of exported services for this bundle.
    protected TestComponentMetadata[] targetComponents;
     ...
     */
    public ComponentMetadataValidator(TestComponentMetadata[] components) {
        super();
        this.targetComponents = components;
    }
     ...
     */
    public ComponentMetadataValidator(TestComponentMetadata component) {
        this(new TestComponentMetadata[] { component });
    }
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        blueprintMetadata.validateComponentMetadata(targetComponents);
    }
}
