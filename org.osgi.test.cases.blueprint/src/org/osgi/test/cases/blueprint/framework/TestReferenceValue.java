...
public class TestReferenceValue extends TestValue {
    // The target component reference
    protected String componentId;

    public TestReferenceValue(String componentId) {
    ...
    public boolean equals(Value v) {
        ...
        return componentId.equals(((ReferenceValue)v).getComponentName());
    }
    ...
    public String toString() {
        return "A reference to component " + componentId;
    }
}
