...
/**
 * Generic validator to verify that the BlueprintContainer
 * getCompliance() method is returning the correct information.
 */
public class GetComplianceValidator extends MetadataValidator {
    // The expected compliance value
    protected int expected;

    /**
     * Validates the metadata for a modules exported services.
     *
     * @param expected The expected returned compliance value.
     */
    public GetComplianceValidator(int expected) {
        super();
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        assertEquals("Incorrect getCompliance() value", expected, context.getCompliance());
    }
}
