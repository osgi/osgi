 ...
 * the expected.
 */
public class PartialArgumentMetadataValidator extends MetadataValidator {
     ...
     */
    public PartialArgumentMetadataValidator(String componentId) {
        this(componentId, new TestArgument[0]);
    }
     ...
     */
    public PartialArgumentMetadataValidator(String componentId, TestArgument[] parms) {
        super();
     ...
     */
    public PartialArgumentMetadataValidator(String componentId, TestArgument parm) {
        this(componentId, new TestArgument[] { parm });
    }
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        blueprintMetadata.validatePartialConstructorMetadata(componentId, parms);
    }
}
