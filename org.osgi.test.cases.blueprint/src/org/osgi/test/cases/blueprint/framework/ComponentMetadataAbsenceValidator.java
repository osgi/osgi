...
/**
 * Generic validator to just verify that a metadata element is absent from
 * the metadata list (used to validate the environment components)
 */
public class ComponentMetadataAbsenceValidator extends MetadataValidator {
    // the id of the target component
    protected String componentId;

    /**
     * Validates the absence of a metadata element for a component.
     *
     * @param componentId
     *               The target component id.
     */
    public ComponentMetadataAbsenceValidator(String componentId) {
        super();
    ...
    public void validate(BundleContext testContext) throws Exception {
        ...
        try {
            ...
            Object component = container.getComponentInstance(componentId);
            fail("Component " + component + " incorrectly exists for bundle " + bundle.getSymbolicName());
