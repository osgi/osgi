...
/**
 * Controller for a standard test of bundles that should not be managed
 * by the blueprint context.  Reasons include type incompatibility with the
 * blueprint API, no configuration files, etc.
 */
public class NonBlueprintTestController extends BaseTestController {
    ...
    public NonBlueprintTestController(BundleContext testContext, String testBundle) throws Exception {
        this(testContext, testBundle, DEFAULT_TIMEOUT);
    }

    public NonBlueprintTestController(BundleContext testContext, String testBundle, long timeout) throws Exception {
        ...
        // in each phase.
        testPhase.addEventSet(new StandardNonBlueprintEventSet(testContext, bundle));
