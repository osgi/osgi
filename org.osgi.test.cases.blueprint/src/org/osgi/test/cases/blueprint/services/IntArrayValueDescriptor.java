 ...
 */
public class IntArrayValueDescriptor extends ValueDescriptor {
      ...
      */
     public IntArrayValueDescriptor(String name, int[] value) {
         super(name, value, int[].class);
     }
