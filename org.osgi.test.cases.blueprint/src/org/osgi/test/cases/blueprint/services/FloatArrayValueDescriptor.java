 ...
 */
public class FloatArrayValueDescriptor extends ValueDescriptor {
      ...
      */
     public FloatArrayValueDescriptor(String name, float[] value) {
     ...
     public boolean equals(Object o) {
         ...
         if (!(other.value instanceof float[])) {
             return false;
         }
         // now validate all of the data
         float[] thisValue = (float[])value;
         float[] otherValue = (float[])other.value;
