 ...
 */
public class ShortArrayValueDescriptor extends ValueDescriptor {
      ...
      */
     public ShortArrayValueDescriptor(String name, short[] value) {
         super(name, value, short[].class);
     }
     ...
     public boolean equals(Object o) {
         ...
         if (!(other.value instanceof short[])) {
             return false;
         }
         // now validate all of the data
         short[] thisValue = (short[])value;
         short[] otherValue = (short[])other.value;
