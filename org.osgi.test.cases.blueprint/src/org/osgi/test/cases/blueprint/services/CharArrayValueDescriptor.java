 ...
 */
public class CharArrayValueDescriptor extends ValueDescriptor {
      ...
      */
     public CharArrayValueDescriptor(String name, char[] value) {
         super(name, value, char[].class);
     }
     ...
     public boolean equals(Object o) {
         ...
         if (!(other.value instanceof char[])) {
             return false;
         }
         // now validate all of the data
         char[] thisValue = (char[])value;
         char[] otherValue = (char[])other.value;
