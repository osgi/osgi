 ...
 */
public class ByteArrayValueDescriptor extends ValueDescriptor {
      ...
      */
     public ByteArrayValueDescriptor(String name, byte[] value) {
         super(name, value, byte[].class);
     }
     ...
     public boolean equals(Object o) {
         ...
         byte[] thisValue = (byte[])value;
         byte[] otherValue = (byte[])other.value;
