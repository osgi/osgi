        ...
        exportStartEvents.addValidator(new ExportedServiceValidator(new ExportedService("GoodServiceService",
                ...
                new MapValueEntry[] {
                    ...
                    new MapValueEntry("test.case.property.java.lang.String.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("abc") }, String.class)),
                    new MapValueEntry("test.case.property.java.lang.Integer.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("11") }, Integer.class)),
                    new MapValueEntry("test.case.property.java.lang.Short.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("12") }, Short.class)),
                    new MapValueEntry("test.case.property.java.lang.Byte.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("13") }, Byte.class)),
                    new MapValueEntry("test.case.property.java.lang.Character.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("a") }, Character.class)),
                    new MapValueEntry("test.case.property.java.lang.Long.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("15") }, Long.class)),
                    new MapValueEntry("test.case.property.java.lang.Boolean.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("false") }, Boolean.class)),
                    new MapValueEntry("test.case.property.java.lang.Float.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("16.0") }, Float.class)),
                    new MapValueEntry("test.case.property.java.lang.Double.Set",
                        new TestSetValue(new TestValue[] { new TestStringValue("17.0") }, Double.class)),

                    new MapValueEntry("test.case.property.java.lang.String.List",
                        new TestListValue(new TestValue[] { new TestStringValue("abc") }, String.class)),
                    new MapValueEntry("test.case.property.java.lang.Integer.List",
                        new TestListValue(new TestValue[] { new TestStringValue("11") }, Integer.class)),
                    new MapValueEntry("test.case.property.java.lang.Short.List",
                        new TestListValue(new TestValue[] { new TestStringValue("12") }, Short.class)),
                    new MapValueEntry("test.case.property.java.lang.Byte.List",
                        new TestListValue(new TestValue[] { new TestStringValue("13") }, Byte.class)),
                    new MapValueEntry("test.case.property.java.lang.Character.List",
                        new TestListValue(new TestValue[] { new TestStringValue("a") }, Character.class)),
                    new MapValueEntry("test.case.property.java.lang.Long.List",
                        new TestListValue(new TestValue[] { new TestStringValue("15") }, Long.class)),
                    new MapValueEntry("test.case.property.java.lang.Boolean.List",
                        new TestListValue(new TestValue[] { new TestStringValue("false") }, Boolean.class)),
                    new MapValueEntry("test.case.property.java.lang.Float.List",
                        new TestListValue(new TestValue[] { new TestStringValue("16.0") }, Float.class)),
                    new MapValueEntry("test.case.property.java.lang.Double.List",
                        new TestListValue(new TestValue[] { new TestStringValue("17.0") }, Double.class)),
                },
                null, null)));
        // we should see a service event here indicating this was registered
