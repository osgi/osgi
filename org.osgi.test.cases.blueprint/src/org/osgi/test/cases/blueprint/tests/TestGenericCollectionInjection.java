...
import org.osgi.test.cases.blueprint.components.injection.GenericHolder;
import org.osgi.test.cases.blueprint.components.injection.GenericListInjection;
import org.osgi.test.cases.blueprint.components.injection.Point;
import org.osgi.test.cases.blueprint.components.injection.Suit;
...
public class TestGenericCollectionInjection extends DefaultTestBundleControl {
    ...
    public void testListCollectionReferenceImport() throws Exception {
        ...
        StandardTestController controller = new StandardTestController(getContext(),
				...
				getWebServer() + "www/managed_service_export2.jar");
 ...
 getWebServer()
						+ "www/managed_service_export2.jar");
    ...
    public void testReferenceListServiceError() throws Exception {
		...
		controller.addSetupBundle(getWebServer()
				+ "www/managed_service_export2.jar");
        controller.run();
    }
