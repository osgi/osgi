...
@InnerRequirementAnnotation
public @interface IndirectRequirementAnnotation {
	//
}

@Requirement( //
		namespace = "testIndirectlyAnnotatedRequirement", //
		name = "allOptions", //
		version = "1.3", //
		filter = "(foo=bar)", //
		effective = "osgi.test", //
...
@interface InnerRequirementAnnotation {
	//
}
