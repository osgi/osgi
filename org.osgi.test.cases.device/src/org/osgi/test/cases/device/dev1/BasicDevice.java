...
public class BasicDevice implements BundleActivator, Device {
  ...
  /**
   * The start method of the activator of the device bundle. Registers different
   * devices depending on the device.test.mode system property. Following values of
   * this property are recognized:
   * 0 - registers a device that implements 
   *		 org.osgi.service.device.Device and there is matching driver for it
   * 1 - registers a device that doesn't implement 
   *  	 org.osgi.service.device.Device and there is matching driver
   * 2 - registers a device that implements 
   *		 org.osgi.service.device.Device and there is NO matching driver for it
   * 3 - registers a device that dooesn't implement 
   *     org.osgi.service.device.Device and there is NO matching driver for it
   * 4 - registers a device that implements 
   *     org.osgi.service.device.Driver but does not set DEVICE_CATEGOR property
   * 100 - registers a general device
   *
  ...
  public void start(BundleContext bc) {
    ...
    switch (mode) {
      case 0 : // basic device that implements org.osgi.service.device.Device with matching driver
        ...
        deviceSR = bc.registerService("org.osgi.service.device.Device", this, h_0);
        break;
      case 1 : // basic device that doesn't implement org.osgi.service.device.Device with matching driver
        ...
        break;
      case 2 : // basic device that implements org.osgi.service.device.Device without matching driver
        ...
        deviceSR = bc.registerService("org.osgi.service.device.Device", this, h_2);
        break;
      case 3 : // basic device that doesn't implement org.osgi.service.device.Device without matching driver
        ...
        break;
      case 4 : // basic device that implements org.osgi.service.device.Driver but does not set
        ...
        deviceSR = bc.registerService("org.osgi.service.device.Device", this, h_4);
        break;
      case 100 : // general device - used by the driver selection test
        ...
        deviceSR = bc.registerService("org.osgi.service.device.Device", this, h_100);
        break;
      default : 
  ...
  /**
   * Should be called when no dirver is found for this device -
   * only for devices that implement org.osgi.service.device.Device.
   */
