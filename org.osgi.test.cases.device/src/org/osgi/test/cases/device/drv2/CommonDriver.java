...
/**
 * A common driver implementation - a driver that will be matched with
 * other drivers but will lose the bidding (through selector or through the
 * default matching algorythm). Its SERVICE_RANKING properti is 42
 *
 * @author ProSyst
 * @version 1.0
 */
public class CommonDriver implements Driver, BundleActivator {
  ...
  /**
   * The start method of the activator of the CommonDriver bundle. 
