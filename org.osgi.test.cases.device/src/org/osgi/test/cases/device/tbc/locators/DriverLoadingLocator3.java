 ...
 * @version 1.0
 */
public class DriverLoadingLocator3 implements org.osgi.service.device.DriverLocator {
  ...
  public String[] findDrivers(Dictionary props) {
    throw new RuntimeException("[findDrivers] Testing the device manager exception handling");
  }
  ...
  public InputStream loadDriver(String id) throws IOException {
    master.log("[Exception throwing locator]", "loaddDriver called with ID " + id + " error!!!!");
    return null;
  }
