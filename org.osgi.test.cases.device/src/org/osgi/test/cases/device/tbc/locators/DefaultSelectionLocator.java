...
public class DefaultSelectionLocator implements DriverLocator {
   ...
   *          drivers that will be filtered from the default selection
   *          algorythm
   */
   ...
   * that are loaded in the default selection test.
   * 
      ...
      return (InputStream)AccessController.doPrivileged(new PrivilegedExceptionAction(){
      	  public Object run() throws Exception 
      	  {
             if ("Driver_Winner".equals(id)) {
               ...
               return url.openStream();    
             } else if ("Driver_Concurent".equals(id)) {
               URL url = new URL(TestBundleControl.tcHome + "drv3.jar");
               return url.openStream();    
             } else {
