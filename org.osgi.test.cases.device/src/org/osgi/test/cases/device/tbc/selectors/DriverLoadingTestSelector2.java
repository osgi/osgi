...
/**
 * Second selector. As stated in the specification this selector should be ignored
 *
 * @author ProSyst
 * @version 1.0
 */
...
public class DriverLoadingTestSelector2 implements DriverSelector {
  ...
  public int select(ServiceReference reference, Match[] matches) {
  	master.log("[Driver loading test selector 2]", "second selector called! Error!");
    throw new RuntimeException("[Driver loading test selector 2] second selector called! Error!");
  }
