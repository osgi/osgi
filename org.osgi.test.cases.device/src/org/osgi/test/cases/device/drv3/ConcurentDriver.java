...
/**
 * A driver implementation that should be a concurence to the WinnerDriver
 * in the default selection algorythm test. With its SERVICE_RANKING of 4242 -
 * as much as the winner - it should lose on the last step of the algorythm
 * because of its higher SERVICE_ID
 *
 * @author ProSyst
 * @version 1.0
 */
...
public class ConcurentDriver implements Driver, BundleActivator {
  ...
  /**
   * The start method of the activator of the ConcurentDriver bundle. 
   ...
   *        will match only with a device with ID (deviceID property)"basicDevice"  
   ...
   * sets the message in the master test case to TestBundleControl.MESSAGE_ERROR because
   * this driver should not be attached - there is always other driver that 
   * should win.
   *
   * @param reference service reference to the registred device. This dirver
  ...
  public String attach(ServiceReference reference) throws Exception {
    log("attaching to " + (String)reference.getProperty("deviceID") + " ERROR!");
