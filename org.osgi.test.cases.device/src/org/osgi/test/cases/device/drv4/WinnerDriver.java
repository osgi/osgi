...
/**
 * This driver is intended to win every time. It is used in all the tests
 * except of the device detection test.
 *
 * @author ProSyst
 * @version 1.0
 */
public class WinnerDriver implements Driver, BundleActivator {
  ...
  /**
   * Checks if this dirver matches to the Device service reference passed. This
   * implementation retunrs 255 every time
   * 
