 ...
 * Service to create <tt>javax.microedition.io.Connection</tt> objects which
 * implement the scheme named by <tt>IO_SCHEME</tt>.
 * 
 * When a <tt>ConnectorService.open</tt> method is called, the implementation
 ...
 * registered with the service property <tt>IO_SCHEME</tt> which matches the
 * scheme. The {@link #createConnection}method of the selected Connection
 * Factory will then be called to create the actual <tt>Connection</tt>
 * object.
 * 
 * @version $Revision$
 */
public interface ConnectionFactory {
	 ...
	 * Factory can create <tt>Connection</tt> objects. This property is of
	 * type <tt>String[]</tt>.
	 */
	 ...
	 * 
	 * @param name The full URI passed to the <tt>ConnectorService.open</tt>
	 *        method
	 * @param mode The mode parameter passed to the
	 *        <tt>ConnectorService.open</tt> method
	 * @param timeouts The timeouts parameter passed to the
	 *        <tt>ConnectorService.open</tt> method
	 * @return A new <tt>javax.microedition.io.Connection</tt> object.
	 * @throws IOException If a <tt>javax.microedition.io.Connection</tt>
