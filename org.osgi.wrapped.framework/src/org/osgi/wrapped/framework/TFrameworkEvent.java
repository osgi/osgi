...
public class TFrameworkEvent extends EventObject {
	 ...
	 *             source.
	 */
	public TFrameworkEvent(int type, Object source) {
		super(source);
		this.type = type;
		this.bundle = null;
		this.throwable = null;
	 ...
	 */
	public TFrameworkEvent(int type, TBundle bundle, Throwable throwable) {
		super(bundle);
		this.type = type;
		this.bundle = bundle;
