 ...
 * @see TAllServiceListener
 * @version $Revision$
 */

public class TServiceEvent extends EventObject {
	 ...
	 * 
	 * @see TServiceRegistration#setProperties
	 */
	 ...
	 * 
	 * @see TServiceRegistration#unregister
	 ...
	 */
	public TServiceEvent(int type, TServiceReference reference) {
		super(reference);
	 ...
	 */
	public TServiceReference getServiceReference() {
		return reference;
	}
