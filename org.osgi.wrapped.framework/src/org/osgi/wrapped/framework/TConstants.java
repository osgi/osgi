...
public interface TConstants {
	 ...
	 * {@link TBundle#START_ACTIVATION_POLICY START_ACTIVATION_POLICY} option
	 * will wait in the {@link TBundle#STARTING STARTING} state until the first
	 ...
	 * 
	 * @see #BUNDLE_ACTIVATIONPOLICY
	 * @see TBundle#start(int)
	 * @see TBundle#START_ACTIVATION_POLICY
	 * @since 1.4
	 */
	 ...
	 * the bundle's identifier (see {@link TBundle#getBundleId}) and followed by
	 ...
	 * order</i> of services, see {@link TServiceReference#compareTo(Object)},
	 * and the <i>default</i> service to be returned from a call to the
	 * {@link TBundleContext#getServiceReference} method.
	 * 
	 * <p>
