 ...
 * 
 * @see TBundleContext#getServiceReference
 * @see TBundleContext#getServiceReferences
 * @see TBundleContext#getService
 * @ThreadSafe
 * @version $Revision$
 */

public interface TServiceReference extends Comparable {
	/**
	 ...
	 * {@link TBundleContext#registerService(String[],Object,Dictionary)} or
	 * {@link TServiceRegistration#setProperties} methods.
	 * 
	 ...
	 * @see TBundleContext#registerService(String[],Object,Dictionary)
	 */
	 ...
	 * <code>ServiceReference</code> have the same {@link TConstants#SERVICE_ID
	 ...
	 * {@link TConstants#SERVICE_RANKING service ranking} and greater if it has a
	 ...
	 * {@link TConstants#SERVICE_RANKING service ranking}, this
	 * <code>ServiceReference</code> is less than the specified
	 * <code>ServiceReference</code> if it has a higher
	 * {@link TConstants#SERVICE_ID service id} and greater if it has a lower
	 * service id.
	 * 
