...
public interface TBundle {
	 ...
	 * include:
	 * <ul>
	 * <li>The bundle's class path from its {@link TConstants#BUNDLE_CLASSPATH}
	 * Manifest header.
	 * <li>The bundle's package dependencies from its
	 * {@link TConstants#EXPORT_PACKAGE} and {@link TConstants#IMPORT_PACKAGE}
	 * Manifest headers.
	 * <li>The bundle's required bundle dependencies from its
	 * {@link TConstants#REQUIRE_BUNDLE} Manifest header.
	 * <li>A fragment bundle's host dependency from its
	 * {@link TConstants#FRAGMENT_HOST} Manifest header.
	 * </ul>
	 * <p>
	 ...
	 * state when the bundle's {@link TBundleActivator#start} is called. If the
	 ...
	 * <p>
	 * If the bundle has a
	 * {@link TConstants#ACTIVATION_LAZY lazy activation policy}, then the
	 ...
	 * when the bundle's {@link TBundleActivator#stop} method is called. When the
	 ...
	 * bundle's declared
	 * {@link TConstants#BUNDLE_ACTIVATIONPOLICY activation policy}.
	 * 
	 * <p>
	 * This bit may be set when calling {@link #start(int)} to notify the
	 ...
	 * 
	 * @since 1.4
	 * @see TConstants#BUNDLE_ACTIVATIONPOLICY
	 * @see #start(int)
	 */
	 ...
	 * bundle's declared activation policy is {@link TConstants#ACTIVATION_LAZY
	 * lazy} then:
	 * <ul>
	 * <li>If this bundle's state is <code>STARTING</code> then this method
	 * returns immediately.
	 * <li>This bundle's state is set to <code>STARTING</code>.
	 * <li>A bundle event of type {@link TBundleEvent#LAZY_ACTIVATION} is fired.
	 ...
	 * <li>This bundle's state is set to <code>STARTING</code>.
	 * 
	 * <li>A bundle event of type {@link TBundleEvent#STARTING} is fired.
	 * 
	 * <li>The {@link TBundleActivator#start} method of this bundle's
	 ...
	 * <li>A bundle event of type {@link TBundleEvent#STOPPING} is fired.
	 ...
	 * <li>A bundle event of type {@link TBundleEvent#STOPPED} is fired.
	 ...
	 * 
	 * <li>A bundle event of type {@link TBundleEvent#STARTED} is fired.
	 * </ol>
	 * 
	 * <b>Preconditions </b>
	 * <ul>
	 ...
	 * @throws TBundleException If this bundle could not be started. This could
	 ...
	 * state to <code>STOPPING</code>, the {@link TBundleActivator#stop} method
	 ...
	 *        options.
	 * @throws TBundleException If this bundle's <code>BundleActivator</code>
	 *         threw an exception or this bundle is a fragment.
	 * @throws IllegalStateException If this bundle has been uninstalled or this
	 *         bundle tries to change its own state.
	 * @throws SecurityException If the caller does not have the appropriate
	 ...
	 * this bundle's {@link TConstants#BUNDLE_UPDATELOCATION
	 ...
	 * bundle event of type {@link TBundleEvent#UPDATED} is fired.
	 * 
	 ...
	 * event of type {@link TFrameworkEvent#ERROR} is fired containing the
	 * exception.
	 * </ol>
	 * 
	 * <b>Preconditions </b>
	 ...
	 *        {@link TConstants#BUNDLE_UPDATELOCATION Bundle-UpdateLocation}
	 ...
	 * @throws TBundleException If the input stream cannot be read or the update
	 *         fails.
	 * @throws IllegalStateException If this bundle has been uninstalled or this
	 *         bundle tries to change its own state.
	 * @throws SecurityException If the caller does not have the appropriate
	 ...
	 * 
	 * @throws TBundleException If the update fails.
	 * @throws IllegalStateException If this bundle has been uninstalled or this
	 *         bundle tries to change its own state.
	 * @throws SecurityException If the caller does not have the appropriate
	 *         <code>AdminPermission[this,LIFECYCLE]</code> for both the current
	 ...
	 * or <code>STOPPING</code>, this bundle is stopped as described in the
	 * <code>Bundle.stop</code> method. If <code>Bundle.stop</code> throws an
	 * exception, a Framework event of type {@link TFrameworkEvent#ERROR} is
	 * fired containing the exception.
	 * 
	 * <li>This bundle's state is set to <code>UNINSTALLED</code>.
	 * 
	 * <li>A bundle event of type {@link TBundleEvent#UNINSTALLED} is fired.
	 * 
	 ...
	 * </ul>
	 * 
	 * @throws TBundleException If the uninstall failed. This can occur if
	 ...
	 * @see TConstants#BUNDLE_LOCALIZATION
	 */
	 ...
	 * {@link TFrameworkEvent#ERROR} is fired containing a
	...
	/**
	 * Returns this bundle's {@link TBundleContext}. The returned
	 ...
	 * specified version then {@link TVersion#emptyVersion} is returned.
	 * 
	 * <p>
