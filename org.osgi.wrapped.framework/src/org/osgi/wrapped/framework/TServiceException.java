...
public class TServiceException extends RuntimeException {
	 ...
	 */
	public TServiceException(String msg, Throwable cause) {
	 ...
	 */
	public TServiceException(String msg) {
	 ...
	 * @param cause The cause of this exception.
	 */
	public TServiceException(String msg, int type, Throwable cause) {
		super(msg, cause);
		this.type = type;
	}
	 ...
	 * @param type The type for this exception.
	 */
	public TServiceException(String msg, int type) {
		super(msg);
		this.type = type;
	}
