...
public class TBundleException extends Exception {
	 ...
	 */
	public TBundleException(String msg, Throwable cause) {
	 ...
	 */
	public TBundleException(String msg) {
	 ...
	 * @since 1.5
	 */
	public TBundleException(String msg, int type, Throwable cause) {
		super(msg, cause);
		this.type = type;
	}
	 ...
	 * @since 1.5
	 */
	public TBundleException(String msg, int type) {
		super(msg);
		this.type = type;
	}
