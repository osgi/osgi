 ...
 * <li>Get the {@link TBundle} object for a bundle.
 ...
 * {@link TBundleActivator#start} method. The same <code>BundleContext</code>
 * object will be passed to the bundle associated with this context when it is
 * stopped using the {@link TBundleActivator#stop} method. A
...
public interface TBundleContext {
	/**
	 ...
	 * {@link TBundleException} is thrown.
	 * 
	 ...
	 * 
	 * <li>A bundle event of type {@link TBundleEvent#INSTALLED} is fired.
	 * 
	 ...
	 * @throws TBundleException If the input stream cannot be read or the
	 *         installation failed.
	 * @throws SecurityException If the caller does not have the appropriate
	 ...
	 * @param location The location identifier of the bundle to install.
	 * @return The <code>Bundle</code> object of the installed bundle.
	 * @throws TBundleException If the installation failed.
	 * @throws SecurityException If the caller does not have the appropriate
	 *         <code>AdminPermission[installed bundle,LIFECYCLE]</code>, and the
	 *         Java Runtime Environment supports permissions.
	 * @throws IllegalStateException If this BundleContext is no longer valid.
	 ...
	 * listeners. See {@link TFilter} for a description of the filter syntax.
	 ...
	 * {@link TConstants#OBJECTCLASS} property. If <code>filter</code> is
	 ...
	 * @throws TInvalidSyntaxException If <code>filter</code> contains an
	 *         invalid filter string that cannot be parsed.
	 * @throws IllegalStateException If this BundleContext is no
	 *         longer valid.
	 * @see TServiceEvent
	 * @see TServiceListener
	 * @see TServicePermission
	 */
	 ...
	 * @throws IllegalStateException If this BundleContext is no
	 *         longer valid.
	 * @see #addServiceListener(TServiceListener, String)
	 */
	 ...
	 * {@link TServiceFactory} interface to have more flexibility in providing
	 ...
	 * <code>null</code>): <br/>
	 * A property named {@link TConstants#SERVICE_ID} identifying the
	 * registration number of the service <br/>
	 * A property named {@link TConstants#OBJECTCLASS} containing all the
	 ...
	 * <li>A service event of type {@link TServiceEvent#REGISTERED} is fired.
	 ...
	 *        properties under the key {@link TConstants#OBJECTCLASS}.
	 * @param service The service object or a <code>ServiceFactory</code>
	 *        object.
	 * @param properties The properties for this service. The keys in the
	 *        properties object must all be <code>String</code> objects. See
	 *        {@link TConstants} for a list of standard service property keys.
	 *        Changes should not be made to this object after calling this
	 *        method. To update the service's properties the
	 *        {@link TServiceRegistration#setProperties} method must be called.
	 ...
	 * {@link TConstants#OBJECTCLASS} property will be an array of string, rather
	 ...
	 * {@link TServiceReference#isAssignableTo(TBundle, String)}.
	 * 
	 * <p>
	 ...
	 * which satisfy the filter expression. See {@link TFilter} for a description
	 ...
	 * an {@link TInvalidSyntaxException} will be thrown with a human readable
	 ...
	 * {@link TConstants#OBJECTCLASS objectClass} property.
	 ...
	 * {@link TServiceReference#isAssignableTo(TBundle, String)} with the context
	 ...
	 *         search.
	 * @throws TInvalidSyntaxException If the specified <code>filter</code>
	 ...
	 * <p>
	 * This method is the same as calling
	 * {@link TBundleContext#getServiceReferences(String, String)} with a
	 * <code>null</code> filter expression. It is provided as a convenience for
	 * when the caller is interested in any service that implements the
	 * specified class.
	 * <p>
	 * If multiple such services exist, the service with the highest ranking (as
	 * specified in its {@link TConstants#SERVICE_RANKING} property) is returned.
	 * <p>
	 * If there is a tie in ranking, the service with the lowest service ID (as
	 * specified in its {@link TConstants#SERVICE_ID} property); that is, the
	 ...
	 * {@link #getService(TServiceReference)} the context bundle's use count for
	 * that service is incremented by one. Each time the service is released by
	 * {@link #ungetService(TServiceReference)} the context bundle's use count
	 ...
	 * {@link TServiceFactory#getService(TBundle, TServiceRegistration)} method is
	 ...
	 * {@link TFrameworkEvent#ERROR} containing a {@link TServiceException}
	 ...
	 * @see #ungetService(TServiceReference)
	 * @see TServiceFactory
	 */
	 ...
	 * the
	 * {@link TServiceFactory#ungetService(TBundle, TServiceRegistration, Object)}
	 ...
	 * 
	 * <p>
	 * If the filter cannot be parsed, an {@link TInvalidSyntaxException} will be
	 * thrown with a human readable message where the filter became unparsable.
	 * 
	 * @param filter The filter string.
	 * @return A <code>Filter</code> object encapsulating the filter string.
	 * @throws TInvalidSyntaxException If <code>filter</code> contains an invalid
	 *         filter string that cannot be parsed.
	 * @throws NullPointerException If <code>filter</code> is null.
	 * @throws IllegalStateException If this BundleContext is no longer valid.
	 * @see "Framework specification for a description of the filter string syntax."
	 * @see TFrameworkUtil#createFilter(String)
	 * @since 1.1
	 */
