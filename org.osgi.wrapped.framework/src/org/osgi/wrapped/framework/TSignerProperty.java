...
class TSignerProperty {
	 ...
	 */
	public TSignerProperty(String pattern) {
	 ...
	 */
	TSignerProperty(TBundle bundle) {
		this.bundle = bundle;
		this.pattern = null;
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof TSignerProperty))
			return false;
		TSignerProperty other = (TSignerProperty) o;
		TBundle matchBundle = bundle != null ? bundle : other.bundle;
		String matchPattern = bundle != null ? other.pattern : pattern;
		Map/* <X509Certificate, List<X509Certificate>> */signers = matchBundle
				.getSignerCertificates(TBundle.SIGNERS_TRUSTED);
