...
public interface TServiceRegistration {
	/**
	 ...
	 * 
	 * <p>
	 * The {@link TConstants#OBJECTCLASS} and {@link TConstants#SERVICE_ID} keys
	 ...
	 * <li>A service event of type {@link TServiceEvent#MODIFIED} is fired.
	 * </ol>
	 * 
	 * @param properties The properties for this service. See {@link TConstants}
	 ...
	 * <li>A service event of type {@link TServiceEvent#UNREGISTERING} is fired
	 ...
	 * If the service was registered with a {@link TServiceFactory} object, the
	 ...
	 *         <code>ServiceRegistration</code> object has already been
	 *         unregistered.
	 * @see TBundleContext#ungetService
	 * @see TServiceFactory#ungetService
	 */
