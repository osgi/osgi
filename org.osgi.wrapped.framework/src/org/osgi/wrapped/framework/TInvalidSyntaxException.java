 ...
 * {@link TFilter} for a description of the filter string syntax.
 * 
 * <p>
...
public class TInvalidSyntaxException extends Exception {
	 ...
	 */
	public TInvalidSyntaxException(String msg, String filter) {
		super(msg);
		this.filter = filter;
	}
	 ...
	 * @since 1.3
	 */
	public TInvalidSyntaxException(String msg, String filter, Throwable cause) {
		super(msg, cause);
		this.filter = filter;
	}
	 ...
	 * @see TBundleContext#addServiceListener(ServiceListener,String)
	 */
